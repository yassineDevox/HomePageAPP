! function(e) {
    ...
    function a(e) {
        ...
        t.length > 0 && 0 === e.length ? (D.show(), D.find(".recent-search").show(), D.find(".autocomplete-results").children().remove()) : 0 === t.length && 0 === e.length && D.hide()
    }

    function o(e) {
        if (P.find(".form-group").length > 0) var t = Math.round(P.find(".form-group").outerWidth(!0));
        "undefined" != typeof D && D.length > 0 && (D.css("left", "auto"), D.css("width", e ? t : "100%"), D.css("max-height", e ? "auto" : j.height() - D.offset().top))
    }
    ...
    function i(t) {
        if (t && t.Name && 0 !== t.Name.length) {
            ...
            }) || (t.Name = t.Name.toLowerCase(), n.unshift(t), s(_.take(n, 3)))
        }
    }
    ...
    function r(t) {
        N.toggleClass("nav-opened"), t = e(t ? t : "#toggle-sidenav"), t.toggleClass("close-it"), T.hasClass("show-search") && T.removeClass("show-search")
    }
    ...
    function l(t) {
        return t && !U ? void e.get("/ajax/header/library", function(t) {
            if (t && t.html && 0 !== t.html.length) {
                ...
                n.find(".menu-items").html(t.html), n.find(".menu-table .arrow").removeClass("hide")
            }
        }).always(function() {
            m(), c(), g(), E(), h()
        }) : (c(), m(), g(), h(), void(U || E()))
    ...
    function c() {
        var t = e(".main-subjects ul"),
            n = u();
        n ? (t.find("li").unbind("mouseenter").unbind("mouseleave"), t.find("li > a").attr("tabindex", "-1"), t.menuAim({
            activate: f,
            deactivate: d
        }), f(".main-subjects ul > li:first-child")) : (t.find("li").unbind("mouseenter").unbind("mouseleave"), t.find("li > a").removeAttr("tabindex"))
    }

    function f(t) {
        e(t).siblings("li").removeClass("active"), e(t).siblings("li").find("button").attr("tabindex", "-1").attr("aria-selected", "false"), e(".subject-details").removeClass("active").attr("aria-hidden", "true"), e(t).addClass("active"), e(t).find("button").removeAttr("tabindex").attr("aria-selected", "true");
    ...
    function h() {
        if (e("#submenu-search").length) {
            var t = u();
            t && !R ? (N.hasClass("member") && e("#submenu-profile").length ? e("#submenu-search").insertBefore("#submenu-profile") : e("#submenu-login").length && e("#submenu-search").insertBefore("#submenu-login"), R = !0, S = !1) : t || !e("#toggle-search").length || S || (e("#submenu-search").insertBefore("#toggle-search"), R = !1, S = !0)
        }
    }

    function m() {
        var t = u();
        t ? (e("#eyebrow .popover-trigger").removeClass("opened"), T.off("mouseenter", "#eyebrow .popover-trigger", b).on("mouseenter", "#eyebrow .popover-trigger", b).off("mouseleave", "#eyebrow .popover-trigger", v).on("mouseleave", "#eyebrow .popover-trigger", v), T.off("keypress", "#eyebrow .submenu-toggle", p).on("keypress", "#eyebrow .submenu-toggle", p).off("click", "#eyebrow .submenu-toggle", y).on("click", "#eyebrow .submenu-toggle", y), T.off("focus", "#eyebrow, .page-main, #main-content", w).on("focus", "#eyebrow, .page-main, #main-content", w)) : (k(), C())
    }

    function b(t) {
        var n = e("keypress" === t.type || "click" === t.type ? e(t.target).hasClass("submenu-toggle") ? t.target : e(t.target).closest(".submenu-toggle") : this),
            a = e(n.find(".popover"));
        n.hasClass("submenu-toggle-cont") ? n = e(n.find(".submenu-toggle")) : n.hasClass("submenu-toggle") && (a = e(n.siblings(".popover"))), n.addClass("active").attr("aria-expanded", "true");
        var o = !1;
        if (a.data("timeout") && (clearTimeout(a.data("timeout")), a.data("timeout", 0)), e(".popover").each(function(t, n) {
                return n = e(n), n[0].id === a[0].id && n.is(":visible") ? (o = !0, !0) : void n.hide()
            }), e("#autocomplete-results").hide(), !o) {
    ...
    function v(t, n) {
        var a = "undefined" != typeof n ? n : e("keypress" === t.type ? e(t.target).hasClass("submenu-toggle") ? t.target : e(t.target).closest(".submenu-toggle") : this),
            o = e(a.find(".popover"));
        a.hasClass("submenu-toggle-cont") ? a = e(a.find(".submenu-toggle")) : a.hasClass("submenu-toggle") && (o = e(a.siblings(".popover"))), a.removeClass("active").attr("aria-expanded", "false"), o.data("timeout") && (clearTimeout(o.data("timeout")), o.data("timeout", 0));
        var i = setTimeout(function() {
            o.hide()
        }, 300);
        o.data("timeout", i)
    ...
    function k() {
        T.off("mouseenter", "#eyebrow .popover-trigger", b).off("mouseleave", "#eyebrow .popover-trigger", v), e("#eyebrow .popover").removeAttr("style")
    }
    ...
    function E() {
        if (!I) {
            ...
            e("#submenu-library").on("keydown", function(n) {
                ...
                if (a && a.length > 0) switch (n.which) {
                    case O.UP:
                    case O.DOWN:
                        var o = n.which === O.UP ? -1 : 1;
                        if ("browse-library" === n.target.id || "submenu-library" !== a || "submenu-library" === a && n.target.classList.contains("submenu-expand")) "submenu-library" === a && t.trigger("libraryMenu.selection.change", o);
                            ...
                            var i = e(n.target),
                                ...
                                u = r.length,
                                l = r.index(i);
                            1 === o ? (l + 1 === u && r[0].focus(), r.filter(":gt(" + l + "):first").focus()) : r.filter(":lt(" + l + "):last").focus()
                        }
                        return !1;
                    case O.TAB:
                        if (n.shiftKey && "submenu-library" === n.target.id) return !0;
                        if ("submenu-library" === a) {
                            if (n.shiftKey && n.target === e(".subject-details:visible a").first()[0]) return n.preventDefault(), t.find(".active").find("button").focus(), !1;
                            if (!n.shiftKey && n.target === e(".subject-details:visible a").last()[0]) return n.preventDefault(), e(".subject-details:visible a:first").focus(), !1
                        }
                        break;
                    case O.ENTER:
                    case O.RIGHT:
                        if (n.target.classList.contains("submenu-expand")) return e(".subject-details:visible a:first").focus(), !1;
                        if (n.which === O.RIGHT && e(n.target).parents(".subject-details")) return !1;
                        break;
                    case O.ESCAPE:
                    case O.LEFT:
                        if ("submenu-library" !== a || "browse-library" === n.target.id || n.target.classList.contains("submenu-expand")) {
                            if (n.which === O.LEFT && e(n.target).parents(".subject-details")) return !1;
                            n.which !== O.LEFT && (v(n, e("#" + a)), e("#browse-library").focus())
                        } else e(".main-subjects li.active > button").focus();
                        return !1
                }
            }), e("#submenu-account").on("keydown", function(t) {
                t.which === O.ESCAPE && (v(t, e("#submenu-account")), e("#submenu-profile-list").focus())
            }), t.on("libraryMenu.selection.change", function(n, a) {
                var o = t.find(".active"),
                    i = t.find(":focus");
                if (0 === i.length) o.find("button").focus();
                else {
                    var s = t.find("li");
                    if (0 === s.index(o) && a === -1) return v(n, e("#submenu-library")), e("#browse-library").focus(), !1;
                    if (s.index(o) == s.length - 1 && a > 0) var r = s.eq(0);
                    else var r = s.eq(s.index(o) + a);
                    f(r), e("button", r).focus()
                }
            }), I = !0
        }
    }
    ...
    if (e(".close-cookie-banner").click(function() {
            var n = e(this),
                a = n.closest(".modal");
            e("#cookieConsentModal").modal("hide"), e(".cookie-content-banner").hide();
            var o = a.attr("id") || "cookieConsentModal";
            o && t("cookieBanner", o)
        }), e.cookie) void 0 === e.cookie("cookieBanner") && e(".cookie-content-banner").removeClass("hide");
    else {
    ...
    e(".alert-banner .close-alert").click(function() {
        ...
        o && (a.Type = o);
        var s = n.data("id");
        s && (a.Id = +s), "undefined" != typeof _ && i(a)
    }), D.on("click", ".recent-search-clear", function() {
        D.find(".recent-search-items li").remove(), D.find(".recent-search").hide(), "undefined" != typeof _ && s(null)
    }), "undefined" != typeof _ ? B.on("keydown", _.debounce(function(t) {
        n(t), e(".autocomplete-results li a").attr("aria-selected", !1)
    }, 100)) : "undefined" != typeof debounce && B.on("keydown", debounce(function(t) {
        n(t), e(".autocomplete-results li a").attr("aria-selected", !1)
    }, 100)), e("#cover-wrapper").on("click", function() {
        r()
    }), L.on("click", function() {
        r(this)
    }), e("#toggle-search").on("click", function() {
        alert("click from inside the hell hahaha ");
        T.toggleClass("show-search"), T.hasClass("show-search") && B.focus()
    }), "ontouchstart" in window && e(".disable-link").attr("href", "javascript:void(0)"), j.resize(function() {
        var e = u();
        l(), e && (T.removeClass("show-search"), L.removeClass("close-it"), N.hasClass("nav-opened") && N.removeClass("nav-opened")), o(e)
    });
    var U = !1;
...
! function(e) {
    function o(o) {
        e(o).find("input:not([type=hidden])").val(""), e(o).find("button[type=submit]").attr("disabled", "disabled").addClass("disabled"), e(o).find("textarea").val(""), e(".form-group.filled").removeClass("filled"), e(".form-group.has-error").removeClass("has-error"), e(".help-block").html("")
    }

    function a() {
        var e = !!navigator.cookieEnabled;
        return "undefined" != typeof navigator.cookieEnabled || e || (document.cookie = "testcookie", e = document.cookie.indexOf("testcookie") != -1), e
    }

    function i() {
        e("#feedback-success, #feedback-failure").hide().addClass("hide"), b.find("fieldset").show().removeClass("hide"), e(".feedback-footer").show(), o("#feedback-footer-form")
    }
    var t = e("body");
    ...
    if (r.length > 0) {
        var c = r.val();
        switch (f.removeClass("inactive-link"), d.attr("href", window.location.protocol + "//" + window.location.host), n.attr("href", window.location.protocol + "//" + window.location.host + "/de"), s.attr("href", window.location.protocol + "//" + window.location.host + "/es"), l.attr("href", window.location.protocol + "//" + window.location.host + "/fr"), c) {
            case "en":
                d.addClass("active-library inactive-link"), d.attr("href", "");
                break;
            case "de":
                n.addClass("active-library inactive-link"), n.attr("href", "");
                break;
            case "es":
                s.addClass("active-library inactive-link"), s.attr("href", "");
                break;
            case "fr":
                l.addClass("active-library inactive-link"), l.attr("href", "")
        }
    }
    var b = e("#feedback-footer-form"),
        h = a() ? "1" : "0";
    b.find("#feedback-failure span").click(i), b.find(".close").click(function() {
        e("#feedback-footer-modal").modal("hide")
    }), e("#feedback-footer-modal").on("hide.bs.modal", i), e("#screen-resolution").val(screen.width + "x" + screen.height), e("#cookies-enabled").val(h), b.length && "function" == typeof b.validator && b.validator().on("input.bs.validator change.bs.validator focusout.bs.validator", function(o, a) {
        e("body").trigger("form.updateSubmit", "#feedback-footer-form")
    }).on("submit", function(o) {
        o.preventDefault(), e(this).find("button[type=submit]").attr("disabled", "disabled").addClass("disabled"), e.post("/ajax/support/feedback", e(this).serialize()).done(function(o) {
            b.find("fieldset").hide().addClass("hide"), e(".feedback-footer").hide(), "OK" == o.Status ? e("#feedback-success").removeClass("hide").show() : e("#feedback-failure").removeClass("hide").show()
        }).fail(function() {
            b.find("fieldset").hide().addClass("hide"), e(".feedback-footer").hide(), e("#feedback-failure").removeClass("hide").show()
        })
    })
}(jQuery);
var lynda = lynda || {};
lynda.webTrackingTransport = {
    ...
    ajax: function(e, t, n) {
        ...
        return this.globalTrackingUrl ? (r = this.createXmlHttpObject(), void(r && (r.open(this.AJAX_METHOD, this.globalTrackingUrl, !0), r.withCredentials = !0, r.setRequestHeader("Content-type", "application/json"), this.csrfToken ? r.setRequestHeader("Csrf-Token", this.csrfToken) : r.setRequestHeader("Csrf-Token", this.getCsrfToken()), r.onreadystatechange = function() {
            if (4 === r.readyState) return 200 !== r.status && 304 !== r.status ? void(n && n("Request returned " + r.status)) : void("function" == typeof t && t(r))
    ...
    fillMissingData: function(e) {
        ...
        n.clientTimestamp || (n.clientTimestamp = this.getTimestamp()), e.eventBody.trackingInfo = n;
        var r = e.eventBody.requestHeader || {};
        return r.pageKey || (r.pageKey = this.lastDisplayMetric), e.eventBody.requestHeader = r, e
    },
    trackPageView: function(e) {
        ...
        return n && (o.eventBody.trackingCode = n), r && (o.eventBody.trackingInfo = r), t ? void this.track(o) : this.logError("You must provide a pageKey")
    },
    ...
    getMetaTag: function(e) {
        ...
        if (i) return i;
        for (t = document.getElementsByTagName("meta"), r = t.length, n = 0; n < r; n++)
...
function setupBrowser() {
    ...
    if (!_rng && n && n.getRandomValues) try {
    ...
    if (!_rng) {
        ...
        _mathRNG = _rng = function() {
            for (var n, r = 0; r < 16; r++) 0 === (3 & r) && (n = 4294967296 * Math.random()), u[r] = n >>> ((3 & r) << 3) & 255;
            return u
...
function v4(n, r, e) {
    var u = r && e || 0;
    "string" == typeof n && (r = "binary" === n ? new BufferClass(16) : null, n = null), n = n || {};
    var o = n.random || (n.rng || _rng)();
    if (o[6] = 15 & o[6] | 64, o[8] = 63 & o[8] | 128, r)
        for (var t = 0; t < 16; t++) r[u + t] = o[t];
    return r || unparse(o)
}
var _rng, _mathRNG, _nodeRNG, _whatwgRNG, _window = "undefined" != typeof window ? window : null;
_window ? setupBrowser() : setupNode();
for (var BufferClass = "function" == typeof Buffer ? Buffer : Array, _byteToHex = [], _hexToByte = {}, i = 0; i < 256; i++) _byteToHex[i] = (i + 256).toString(16).substr(1), _hexToByte[_byteToHex[i]] = i;
var uuid = v4;
uuid.v4 = v4, uuid.unparse = unparse, uuid.BufferClass = BufferClass, uuid._rng = _rng, uuid._mathRNG = _mathRNG, uuid._nodeRNG = _nodeRNG, uuid._whatwgRNG = _whatwgRNG, void 0 != lynda && (lynda.uuid = uuid);
! function(e) {
    function n(e, n) {
        if (n) {
            var a = t();
            a && window.sessionStorage.setItem("pageTrackingId", a), r("PageViewEvent", g = n)
        }
    }
    ...
    function r(n, a, r, t) {
        ...
        "undefined" != typeof t && (i.eventInfo.topicName = t), r && (i.eventBody = e.extend(i.eventBody, r)), p && "" != p && (i.eventBody.header.applicationViewerUrn = p), window.sessionStorage.getItem("pageTrackingId") && (i.eventBody.header.pageInstance = {
            pageUrn: "urn:li:page:" + a,
            trackingId: window.sessionStorage.getItem("pageTrackingId")
        });
        var d = e.cookie("litracktestid");
        "undefined" != typeof d && d.length > 0 && (i.eventBody.header.testId = d), lynda.webTrackingTransport.track(i)
    }

    function t() {
        var e = new Array(16);
        return lynda.uuid.v4(null, e), i(e)
    }

    function i(e) {
        for (var n, a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = [], t = 0, i = e.length, d = i % 3, o = i - d; t < o;) n = e[t] << 16, n |= e[t + 1] << 8, n |= e[t + 2], r.push(a.charAt(n >>> 18 & 63)), r.push(a.charAt(n >>> 12 & 63)), r.push(a.charAt(n >>> 6 & 63)), r.push(a.charAt(63 & n)), t += 3;
        switch (d) {
            case 2:
                n = e[t] << 16, n |= e[t + 1] << 8, r.push(a.charAt(n >>> 18 & 63)), r.push(a.charAt(n >>> 12 & 63)), r.push(a.charAt(n >>> 6 & 63)), r.push("=");
                break;
            case 1:
                n = e[t] << 16, r.push(a.charAt(n >>> 18 & 63)), r.push(a.charAt(n >>> 12 & 63)), r.push("="), r.push("=")
        }
        return r.join("")
    }
    if ("undefined" != typeof lynda) {
        var d = e("body"),
            ...
            u = lynda.sessionId,
            y = lynda.browserId;
        s && l && g && lynda.webTrackingTransport && lynda.webTrackingTransport.track && (lynda.webTrackingTransport.setTrackingUrl(l), d.bind("li.track.page", n), d.bind("li.track.action", a), n(null, g), lynda.generateTrackingId = t)
    }
}(jQuery);
var trackingModule = function() {
    ...
    return e.sendPageKey = function(e) {
        ...
        if ("function" == typeof RumTracking) {
            var a = "",
                i = "0",
                t = "";
            if ("undefined" != typeof lynda && ("undefined" != typeof lynda.rumTrackingEnabled && (i = lynda.rumTrackingEnabled), a = n(e), "undefined" != typeof lynda.rumTrackingAppId && (t = lynda.rumTrackingAppId)), "undefined" != typeof a && "undefined" != typeof i && "1" == i) {
                var r = window.rumConfig || {};
                r["beacon-service"] = "tracking", r["navigation-timing-only"] = !0, r["is-single-page-app"] = !1, r["topic-name"] = "LyndaRealUserMonitoringEvent", r["beacon-url"] = "https://www.linkedin.com/lynda/tracking", r["app-id"] = t, r["enable-rs-timing"] = !0, r["rs-sample-rate"] = {
                    "default": 0
                }, r["request-sampling-rate"] = .05;
                var d = RumTracking(r);
                window.RUM2 = d, d.setPageKey(a)
            }
        }
    ...
    }, e.useDefaultPageKey() && e.sendPageKey(), e
}(trackingModule || {});
! function(a) {
    function e(a) {
    ...
    if ("undefined" != typeof ga) {
        ...
        t.on("ga.event", function(a, e) {
            ...
            e.label && (t.eventLabel = e.label), e.value && (t.eventValue = e.value), ga("send", t)
            ...
            if ((!g.length || g.is(i)) && !i.hasClass("disabled") && !i.attr("disabled")) {
                ...
                i.data("gaValue") && (r.eventValue = i.data("gaValue")), i.data("gaContextItem") || (r.eventLabel = e(i) + r.eventLabel), ga("send", r)
            }
        }), t.on("click", ".tl", function() {
            var e = a(this);
            if (!e.hasClass("disabled") && !e.attr("disabled")) try {
...
! function(t) {
    MediaElementPlayer.prototype.buildcustomcc = function(a, n, c, i) {
        if (!t("html").hasClass("no-cc")) {
            ...
            e.attr("id", "player-cc"), e.attr("title", lynda.translate("Captions/Subtitles"))
        }
    }
}(jQuery);
! function(t) {
    t.extend(mejs.MepDefaults, {
        ...
        buildtracks: function(e, i, s, n) {
            if (0 !== e.tracks.length) {
                ...
                if (o.domNode.textTracks)
                    for (a = o.domNode.textTracks.length - 1; a >= 0; a--) o.domNode.textTracks[a].mode = "hidden";
                e.chapters = t('<div class="mejs-chapters mejs-layer"></div>').prependTo(s).hide(), e.captions = t('<div class="mejs-captions-layer mejs-layer"><div class="mejs-captions-position mejs-captions-position-hover" role="log" aria-live="assertive" aria-atomic="false"><span class="mejs-captions-text"></span></div></div>').prependTo(s).hide(), e.captionsText = e.captions.find(".mejs-captions-text"), e.captionsButton = t('<div class="mejs-button mejs-captions-button"><button type="button" aria-controls="' + o.id + '" title="' + o.options.tracksText + '" aria-label="' + o.options.tracksText + '"></button><div class="mejs-captions-selector"><ul><li><input type="radio" name="' + e.id + '_captions" id="' + e.id + '_captions_none" value="none" checked="checked" /><label for="' + e.id + '_captions_none">' + mejs.i18n.t("None") + "</label></li></ul></div></div>").appendTo(i);
                var r = 0;
                for (a = 0; a < e.tracks.length; a++) "subtitles" == e.tracks[a].kind && r++;
                for (o.options.toggleCaptionsButtonWhenOnlyOne && 1 == r ? e.captionsButton.on("click", function() {
                        ...
                        }), e.container.toggleClass("show-captions"), null === e.selectedTrack ? lang = e.tracks[0].srclang : lang = "none", e.setTrack(lang)
                    ...
                    }), e.trackToLoad = -1, e.selectedTrack = null, e.isLoadingTrack = !1, a = 0; a < e.tracks.length; a++) "subtitles" == e.tracks[a].kind && e.addTrackButton(e.tracks[a].srclang, e.tracks[a].label);
                e.loadNextTrack(), n.addEventListener("timeupdate", function(t) {
                    e.displayCaptions()
                }, !1), "" !== e.options.slidesSelector && (e.slidesContainer = t(e.options.slidesSelector), n.addEventListener("timeupdate", function(t) {
                    e.displaySlides()
        ...
        setTrack: function(e) {
            var i, s = this;
            if ("none" == e) s.selectedTrack = null, s.captionsButton && (s.captionsButton.removeClass("mejs-captions-enabled"), s.captionsButton.find("i").removeClass("current"), s.container.removeClass("show-captions"), s.captions.hide());
            else
                for (i = 0; i < s.tracks.length; i++)
                    if (s.tracks[i].srclang == e) {
                        null === s.selectedTrack && s.captionsButton && (s.captionsButton.addClass("mejs-captions-enabled"), s.captionsButton.find("i").addClass("current"), s.container.addClass("show-captions")), s.selectedTrack = s.tracks[i], s.captions.attr("lang", s.selectedTrack.srclang), s.displayCaptions();
                        break
                    } t(this.media).trigger("track.set", e)
        },
        loadNextTrack: function() {
            var t = this;
            t.trackToLoad++, t.trackToLoad < t.tracks.length ? (t.isLoadingTrack = !0, t.loadTrack(t.trackToLoad)) : (t.isLoadingTrack = !1, t.checkForTracks())
        },
        loadTrack: function(e) {
            var i = this,
                s = i.tracks[e],
                n = function() {
                    s.isLoaded = !0, i.enableTrackButton(s.srclang, s.label), i.loadNextTrack()
                };
            s.src && s.src.length ? t.ajax({
                url: s.src,
                dataType: "text",
                success: function(t) {
                    "string" == typeof t && /<tt\s+xml/gi.exec(t) ? s.entries = mejs.TrackFormatParser.dfxp.parse(t) : s.entries = mejs.TrackFormatParser.webvtt.parse(t), n(), "chapters" == s.kind && i.media.addEventListener("play", function(t) {
        ...
        enableTrackButton: function(e, i) {
            var s = this;
            "" === i && (i = mejs.language.codes[e] || e), s.captionsButton.find("input[value=" + e + "]").prop("disabled", !1).siblings("label").html(i), s.options.startLanguage == e && t("#" + s.id + "_captions_" + e).prop("checked", !0).trigger("click"), s.adjustLanguageBox()
        },
        addTrackButton: function(e, i) {
            var s = this;
            "" === i && (i = mejs.language.codes[e] || e), s.captionsButton.find("ul").append(t('<li><input type="radio" name="' + s.id + '_captions" id="' + s.id + "_captions_" + e + '" value="' + e + '" disabled="disabled" /><label for="' + s.id + "_captions_" + e + '">' + i + " (loading)</label></li>")), s.adjustLanguageBox(), s.container.find(".mejs-captions-translations option[value=" + e + "]").remove()
        },
            ...
            if ("undefined" != typeof this.tracks) {
                ...
                if (null !== i && i.isLoaded) {
                    for (t = 0; t < i.entries.times.length; t++)
                        if (e.media.currentTime >= i.entries.times[t].start && e.media.currentTime <= i.entries.times[t].stop) return e.captionsText.html(i.entries.text[t]).attr("class", "mejs-captions-text " + (i.entries.times[t].identifier || "")), void e.captions.show();
                    e.captions.hide()
        ...
        setupSlides: function(t) {
            var e = this;
            e.slides = t, e.slides.entries.imgs = [e.slides.entries.text.length], e.showSlide(0)
        },
        ...
        displaySlides: function() {
            if ("undefined" != typeof this.slides) {
                var t, e = this,
                    i = e.slides;
                for (t = 0; t < i.entries.times.length; t++)
                    if (e.media.currentTime >= i.entries.times[t].start && e.media.currentTime <= i.entries.times[t].stop) return void e.showSlide(t)
            }
        },
        ...
        drawChapters: function(e) {
            var i, s, n = this,
                a = 0,
                o = 0;
            for (n.chapters.empty(), i = 0; i < e.entries.times.length; i++) s = e.entries.times[i].stop - e.entries.times[i].start, a = Math.floor(s / n.media.duration * 100), (a + o > 100 || i == e.entries.times.length - 1 && a + o < 100) && (a = 100 - o), n.chapters.append(t('<div class="mejs-chapter" rel="' + e.entries.times[i].start + '" style="left: ' + o.toString() + "%;width: " + a.toString() + '%;"><div class="mejs-chapter-block' + (i == e.entries.times.length - 1 ? " mejs-chapter-block-last" : "") + '"><span class="ch-title">' + e.entries.text[i] + '</span><span class="ch-time">' + mejs.Utility.secondsToTimeCode(e.entries.times[i].start) + "&ndash;" + mejs.Utility.secondsToTimeCode(e.entries.times[i].stop) + "</span></div></div>")), o += a;
            n.chapters.find("div.mejs-chapter").click(function() {
                n.media.setCurrentTime(parseFloat(t(this).attr("rel"))), n.media.paused && n.media.play()
            }), n.chapters.show()
        }
    }), mejs.language = {
        codes: {
        ...
        webvtt: {
            ...
            parse: function(e) {
                for (var i, s, n, a = 0, o = mejs.TrackFormatParser.split2(e, /\r?\n/), r = {
                    ...
                    if (i = this.pattern_timecode.exec(o[a]), i && a < o.length) {
                        for (a - 1 >= 0 && "" !== o[a - 1] && (n = o[a - 1]), a++, s = o[a], a++;
                            "" !== o[a] && a < o.length;) s = s + "\n" + o[a], a++;
                        s = t.trim(s).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, "<a href='$1' target='_blank'>$1</a>"), r.text.push(s), r.times.push({
                            identifier: n,
        ...
        dfxp: {
            parse: function(e) {
                e = t(e).filter("tt");
                var i, s, n = 0,
                    a = e.children("div").eq(0),
                    o = a.find("p"),
                    r = e.find("#" + a.attr("style")),
                    c = {
                        text: [],
                        times: []
                    };
                if (r.length) {
                    ...
                    if (l.length)
                        for (i = {}, n = 0; n < l.length; n++) i[l[n].name.split(":")[1]] = l[n].value
                }
                for (n = 0; n < o.length; n++) {
                    ...
                    if (o.eq(n).attr("begin") && (p.start = mejs.Utility.convertSMPTEtoSeconds(o.eq(n).attr("begin"))), !p.start && o.eq(n - 1).attr("end") && (p.start = mejs.Utility.convertSMPTEtoSeconds(o.eq(n - 1).attr("end"))), o.eq(n).attr("end") && (p.stop = mejs.Utility.convertSMPTEtoSeconds(o.eq(n).attr("end"))), !p.stop && o.eq(n + 1).attr("begin") && (p.stop = mejs.Utility.convertSMPTEtoSeconds(o.eq(n + 1).attr("begin"))), i) {
                        d = "";
                        for (var h in i) d += h + ":" + i[h] + ";"
                    }
                    d && (p.style = d), 0 === p.start && (p.start = .2), c.times.push(p), s = t.trim(o.eq(n).html()).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, "<a href='$1' target='_blank'>$1</a>"), c.text.push(s), 0 === c.times.start && (c.times.start = 2)
                }
                return c
            }
        },
        ...
        var i, s = [],
            n = "";
        for (i = 0; i < t.length; i++) n += t.substring(i, i + 1), e.test(n) && (s.push(n.replace(e, "")), n = "");
        return s.push(n), s
    })
}(mejs.$);
! function(a) {
    ...
    MediaElementPlayer.prototype.buildcodepractice = function(t, c, i, n) {
        ...
        if (a("html").hasClass("inline-codepractice")) {
            ...
            a('<div class="mejs-button mejs-code-practice hide"><button id="player-code-practice" class="launch-code-practice ga" data-ga-action="click" data-ga-label="player-practicelaunch" data-src="PlayerButton" type="button" aria-controls="' + this.id + '" aria-label="' + d + '" title="' + l + '"><span class="hidden-xs">' + d + "</span></button></div>").appendTo(c), o.on("course.video.change", function(a, t, c, i) {
                e(c)
            }), e(s)
        }
    }
...
! function(e) {
    MediaElementPlayer.prototype.buildcustomendplate = function(t, n, o, a) {
        var d = e("#endplate-temp"),
            l = d.html();
        d.remove(), t.customendplate = e(l).prependTo(o).hide(), e("body").on("course.video.showendplate", function() {
            var n = e("#nonmember-endplate-temp");
            n.length && (e("#endplate-placeholder").html(n.html()), n.remove());
...
! function(e) {
    MediaElementPlayer.prototype.buildcustomfullscreen = function(l, n, a, t) {
        ...
        i.attr("id", "player-fs"), i.attr("title", lynda.translate("Full screen (f)")), i.on("click", function() {
            e(".mejs-settings-layer,.mejs-playback-rate-layer").hide(), e("body").trigger("ga.event", {
                action: "click",
...
! function(a) {
    MediaElementPlayer.prototype.buildcustomplaypause = function(e, p, l, t) {
        ...
        this.options.playText, this.options.pauseText;
        s("pse"), n.on("click", function() {
...
! function(t) {
    MediaElementPlayer.prototype.buildcustompopout = function(o, e, n, i) {
        ...
        o.customPopoutPanel = t('<div class="mejs-popout-layer mejs-layer"><div class="mejs-popout-layer-content popout">' + a + '<br><button id="btn-closePopout" type="button" class="btn btn-secondary "><i class="lyndacon"></i> <span>' + p + "</span></button></div></div>").prependTo(n).hide(), t('<div class="mejs-settings-section popout"><div class="mejs-button mejs-popout-button"><button id="player-popout" type="button" aria-controls="' + this.id + '" aria-label="' + s + '"><i class="lyndacon player-pop-out"></i>' + s + "</button></div></div>").appendTo(".mejs-settings-position").click(function() {
            t(".mejs-settings-layer").hide(), t("body").trigger("ga.event", {
                action: "click",
...
! function(e) {
    MediaElementPlayer.prototype.buildcustompostroll = function(o, l, t, n) {
        ...
        o.custompostroll = e("#postroll-template").remove().children().prependTo(t).hide(), element = e(n), element.on("showpostroll", function(l, n) {
            n = n || r.find('link[rel="postroll"]').attr("href"), n && e.ajax({
                url: n,
                headers: {
                ...
                }), o.custompostroll.show(), o.pause(), t.find(".mejs-postroll-layer-content").html(l.html), element.addClass("has-postroll"), element.trigger("postroll.show")
            })
        }), element.on("play playing hidepostroll", function() {
            element.removeClass("has-postroll"), o.custompostroll.hide(), t.find(".mejs-postroll-layer-content").html("")
        })
    }
}(jQuery);
! function(e) {
    ...
    a.extend(mejs.MepDefaults, {
        ...
        buildsettings: function(t, e, i, s) {
            ...
            function n(t, e) {
                ...
                g || "playerspeed" === i ? (o.hide(), g = !0, "playerspeed" !== i && f.removeClass("hasPopout")) : (a(".tooltip").hide(), o.show(), a(".mejs-settings-position").find("ul:first li:first a").focus(), f.addClass("hasPopout")), g = !g
            }
            var r = !1,
            ...
            if (p) {
                if (p.quality) {
                    ...
                    y.find("a").removeClass("current"), y.find("a[data-quality=" + +p.quality + "]").addClass("current")
                }
                if (r && p.playbackRate) {
                    var b = o.find(".playback-rates");
                    b.find("a").removeClass("current"), b.find('a[data-playback-rate="' + p.playbackRate.toString().replace("0.", ".") + '"]').addClass("current")
                }
                if ("undefined" != typeof p.continuousPlay) {
                    var v = o.find(".continuous-play");
                    v.find("a").removeClass("current"), v.find("a[data-continuous-play=" + p.continuousPlay + "]").addClass("current")
                }
            }
            var g = !1,
                f = a("body");
            u.click(function(a) {
                f.trigger("settings.click", a), f.trigger("ga.event", {
                    action: "click",
                    label: "player-settings-" + (g ? "show" : "hide")
                })
            }), o.bind("click", function(t) {
                !a("html").hasClass("mejs-fullscreen") || a(t.target).hasClass("mejs-settings-position") || t.target.tagName.match(/(button|a)/gi) || (o.hide(), g = !1)
            }), o.find(".mejs-settings-position").bind("mouseleave", function() {
                n()
            }), r && o.find(".playback-rates li a").click(function(e) {
                e.preventDefault();
                var i = a(e.target);
                o.find(".playback-rates li a").removeClass("current"), i.addClass("current"), s.playbackRate = +i.data("playbackRate"), t.$media.trigger("settings.save", {
                ...
                e.preventDefault();
                var i = a(e.target);
                o.find(".stream-qualities li a").removeClass("current"), i.addClass("current");
                ...
                e.preventDefault();
                var i = a(e.target);
                o.find(".continuous-play span a").removeClass("current"), i.addClass("current");
                ...
                if (a.inArray("720", e) === -1) {
                    ...
                    s.hasClass("current") && (s.removeClass("current"), i.find("a[data-quality=540]").addClass("current")), setTimeout(function() {
                        s.hide()
                    }, 100)
                }
    ...
    t.extend(mejs.MepDefaults, {
        ...
        buildskipback: function(e, a, i, n) {
            ...
            t('<div class="mejs-button mejs-skip-back-button"><button id="player-skip-back" type="button" aria-controls="' + s.id + '" title="' + l + '" aria-label="' + l + '"><i class="lyndacon player-rewind"></i></button></div>').appendTo(a).click(function() {
                ...
                }), n.setCurrentTime(Math.max(n.currentTime - s.options.skipBackInterval, 0)), t(this).find("button").blur(), t(n).trigger("seeked", e)
            })
        }
    })
}(jQuery);
    ...
    a.extend(mejs.MepDefaults, {
        ...
        if (!lynda || lynda.hasPlayerSpeedMenu) {
            var c = '<div class="mejs-playback-rate-layer">                       <div class="mejs-popout-menu mejs-playback-rate-position">                            <ul class="playback-rates">                                <li><a data-playback-rate="2">2x</a></li>                                <li><a data-playback-rate="1.75">1.75x</a></li>                                <li><a data-playback-rate="1.5">1.5x</a></li>                                <li><a data-playback-rate="1.25">1.25x</a></li>                                <li><a data-playback-rate="1" class="current">1x</a></li>                                <li><a data-playback-rate=".75">0.75x</a></li>                                <li><a data-playback-rate=".5">0.5x</a></li>                            </ul>                        </div>                    </div>',
                ...
                y = 1,
                b = r();
            b && b.playbackRate && (y = b.playbackRate, n.find(".playback-rates li a.current").removeClass("current"), n.find('a[data-playback-rate="' + y.toString().replace("0.", ".") + '"]').addClass("current")), d.find(".text").text(y + "x");
            var k = !1,
                u = a("body");
            o.on("click", function(t) {
                u.trigger("playerspeed.click", t), a("body").trigger("ga.event", {
                    action: "click",
                    label: "player-playback-rate-menu"
                })
            }), n.bind("click", function(t) {
                !a("html").hasClass("mejs-fullscreen") || a(t.target).hasClass("mejs-playback-rate-position") || t.target.tagName.match(/(button|a)/gi) || (n.hide(), k = !1)
            }), n.find(".mejs-playback-rate-position").on("mouseleave", function(a) {
                s(a)
            }), n.find(".playback-rates li a").click(function(e) {
                e.preventDefault(), e.stopPropagation();
                var l = a(e.target);
                n.find(".playback-rates li a.current").removeClass("current"), l.addClass("current"), i.playbackRate = +l.data("playbackRate"), t.$media.trigger("settings.save", {
                    playbackRate: i.playbackRate
                }), d.find(".text").text(i.playbackRate + "x"), a("body").trigger("ga.event", {
                    action: "click",
...
! function(e) {
    MediaElementPlayer.prototype.buildcustomvolume = function(t, a, l, u) {
        ...
        m.attr("id", "player-mute-toggle"), m.attr("title", lynda.translate("Mute")), m.attr("aria-label", lynda.translate("Mute"));
        var n = e(".mejs-volume-button button i"),
            i = e.cookie("player");
        if (i) {
            var d = JSON.parse(i);
            d && (d.volume && (u.volume = d.volume), u.muted = !!d.muted)
        }
        m.on("click", function() {
            e("body").trigger("ga.event", {
                action: "click",
            ...
            if (a) {
                var l = JSON.parse(a);
                l.volume = u.volume, l.muted = !!u.muted, r(l)
            } else r({
                volume: u.volume,
                muted: !!u.muted
            });
    ...
    a(document).on("keydown", function(a) {
        ...
        t.find(n.tabcontainer || "li").each(function() {
            ...
            t.find(n.tabselector || "ul li").each(function(t) {
                var o = a(this);
                t < (n.tabsize || 10) ? o.attr("tabindex", 0) : o.attr("tabindex", -1), o.find(n.tabignore || "a").attr("tabindex", -1), o.closest(n.tabcontainer || "li").find(n.tabbutton || "button").attr("tabindex", 0)
            })
        })
    })
}(jQuery);
! function(e) {
    function n(n, t) {
        e("#alert").remove(), n.attr("id", "alert"), n.find(".alert-content").html(t), n.insertAfter(e("#eyebrow, .page-main>.title-banner").last()), n.on("click", ".close", function() {
            n.trigger("detach.ScrollToFixed"), n.remove()
        });
    ...
    alertTemplateWarning = e("#alert-template-warning"), alertTemplateDanger = e("#alert-template-danger"), t.on("alert.info", function(e, t) {
    ...
    r.on("scrolly.scrollComplete", function() {
        ...
        if (e && 0 !== e.length) {
            var o = {
                ...
                i = t.data("gaCategory");
            o.category = i && i.length ? i : n, r.trigger("ga.event", [o])
        }
    }), a(function() {
        a.fn.appear && a.fn.appear.run()
    })
...
! function(e) {
    function t(t) {
        function o() {
            if (x && x.abort(), null !== E) {
                ...
                t = "function" == typeof E ? E({
                    ...
                    limit: T
                }) : E.replace("<%= val %>", encodeURIComponent(u.val())).replace("<%= limit %>", T), x = e.get(t).done(l).always(c)
            }
        }

        function l(t) {
            if (h.length) {
                if (a.trigger("autocomplete.cancel"), h.empty(), t && t.html.length) {
                    var n = e(t.html).find("li");
                    n.length ? (h.html(t.html), p.length && p.clone().show().appendTo(h.find(".autocomplete-results"))) : f.length && f.clone().show().appendTo(h), i(n.length)
                } else f.length && (f.clone().show().appendTo(h), i(0));
        ...
        s.length && s.on("submit", function(e) {
            ...
            a.trigger("autocomplete.input", [u.val()])
        }, R)), u.on("keydown", function(e) {
            switch (e.which) {
                case n.ESCAPE:
                    return a.trigger("autocomplete.cancel"), !1;
                case n.UP:
                case n.DOWN:
                    return a.trigger("autocomplete.selection.change", [e.which === n.UP ? -1 : 1]), !1;
                case n.ENTER:
                    return a.trigger("autocomplete.cancel"), s.submit(), !1
            }
            ...
            a.trigger("autocomplete.focus"), a.trigger("autocomplete.show")
        });
        var P = !1;
        u.on("focusout", function(e) {
            return P ? (P = !1, !1) : (a.trigger("autocomplete.blur"), a.trigger("autocomplete.cancel"), void h.hide())
            ...
            d.length && d.hide(), D && D.length > 0 && (t.preventDefault(), D.find("a").get(0).click())
        }), a.on("autocomplete.clear", function(e) {
            e.preventDefault(), u.val(""), d.hide(), D = null, h.empty()
        }), a.on("autocomplete.input", function(e, t) {
            return 0 === t.length || t.length <= k ? (a.trigger("autocomplete.cancel"), w.length && w.hide(), void(d.length && d.hide())) : (d.length && d.show(), void o())
        }), a.on("autocomplete.show", function(t) {
            if (h.length && (h.show(), g.attr("aria-expanded", !0)), w.length) {
                w.show();
            ...
            h.hide(), g.attr("aria-expanded", !1), x && x.abort()
        }), a.on("autocomplete.selection.change", function(t, n) {
            if (h.length) {
                var a = h.find(".current"),
                    o = h.find("li");
                e(o).find("a").attr("aria-selected", !1), g.attr("aria-activedescendant", ""), 0 === a.length ? D = o.first().addClass("current").focus() : (o.removeClass("current"), D = o.eq(o.index(a) + n).addClass("current").focus());
                var l = e(e(D).find("a"));
                l.attr("aria-selected", !0), g.attr("aria-activedescendant", l.attr("id"))
            }
        }), d.length && d.on("click", function(e) {
            e.preventDefault(), u.val(""), h.empty(), d.hide()
        })
    }
    var n = {
            ENTER: 13,
...
! function(e) {
    e("body").on("click", ".bookmark-this-page", function(i) {
        ...
        else if (window.sidebar && window.sidebar.addPanel) window.sidebar.addPanel(t, o, "");
        else {
...
! function(e) {
    var a = {
        ...
        seenIt: function(o, i, s, n) {
            ...
            if (a.notify(o, i, s), "splash" === o ? t = "started" : "tagAlong" === o ? t = "seen" : "banners" === o && (t = n ? a.settings.seen : void 0 == l ? 1 : Number(l) + 1), e.cookie)
                if (l && l.length) {
                ...
                } else a.notify("no cookie saved for you!"), e.cookie(i, t, {
                    raw: !0,
                    path: "/",
                    expires: a.settings.sleep
                });
            ...
            } else createCookie(i, t, a.settings.sleep)
        },
        reloadIt: function() {
            e(".splash-video-thumb").show(), e(".splash-video-content").hide().html('<div id="player"></div>')
        },
        moveIt: function(o, i) {
            a.notify("splash moved to pane " + i), e(".migration > .splash-overlay").find(".pane").fadeOut(), e(".migration > .splash-wrapper").find(".pane").removeClass("splashOpen"), e("#pane-" + i).addClass("splashOpen").fadeIn(), a.reloadIt()
        },
        logIt: function(o, i) {
            e.ajax({
                dataType: "json",
                ...
                a.notify("logging call failed"), a.notify(e)
            })
        },
        viewedIt: function() {
            e.ajax({
                ...
                a.notify("failed to log viewed for splash page"), a.notify(e)
            })
        },
        playIt: function() {
            function o() {
            ...
            if (e(".splash-video-thumb").hide(), e(".splash-video-content").show(), a.loaded === !1) {
                var i = document.createElement("script");
                i.src = "https://ajax.googleapis.com/ajax/libs/swfobject/2.2/swfobject.js";
                var s = document.getElementsByTagName("script")[0];
                s.parentNode.insertBefore(i, s);
                var n = document.createElement("script");
                n.src = "https://www.youtube.com/iframe_api", s.parentNode.insertBefore(n, s)
            }
            var t;
            window.setTimeout(function() {
                o(), a.logIt("splash-video", "viewed")
            }, 500)
        },
        listen: function() {
            a.notify("listing for events"), e("body").on("click", ".tagalong-close", function() {
                a.notify("tagAlong Hidden"), a.lowerIt("tagAlong"), a.logIt("toast", "dismissed")
            }), e("body").on("showTagAlong", function() {
                var o = e(this),
                    i = o.data();
                a.notify("tagAlong Shown"), a.raiseIt("tagAlong", i.open, "raised", !1)
            }), e("body").on("click", ".splash-nav-item", function() {
                var o = e(this),
                    i = o.data();
                a.moveIt(o, i.pane), a.logIt("splash_step_" + i.pane, "impression"), a.logIt("splash-nav", "click")
            }), e("body").on("click", ".splash-close", function() {
                a.lowerIt("splash"), a.logIt("splash", "dismissed")
            }), e("body").on("click", ".splash", function() {
                var o = e(this),
                    i = o.data(),
                    s = e(o).parent().hasClass("tagalong-banner") ? "tagAlong" : "splash";
                "main" === i.location && a.seenIt("banners", a.cookieName.banners, "migrationBanners", !0), a.raiseIt("splash", i.open, s, !1), a.logIt(i.source, "click")
            }), e("body").on("click", ".splash-video", function() {
                var o = e(this),
                    i = o.data();
                "main" === i.location && a.seenIt("banners", a.cookieName.banners, "migrationBanners", !0), a.raiseIt("splash", 1, "splash", !0), a.logIt(i.source, "click")
                ...
                var o = e(this),
                    i = o.data();
                a.notify("Splash Shown"), a.raiseIt("splash", i.open, "splash", !1)
            }), e("body").on("click", ".initiate-migration", function() {
                a.logIt("splash_step_2", "click"), window.location.href = a.urls.initiate
            }), e("body").on("keyup", function(e) {
                27 === e.which && (a.lowerIt("splash"), a.logIt("splash", "dismissed"))
            }), e(".footer-splash").on("click", function() {
                window.scrollTo(0, 0), a.logIt("splash_step_1", "impression")
            }), e(".migration > .splash-bg").addClass("loaded"), e("html").hasClass("legacy") && (e(".migration > .splash-bg").addClass("legacy"), e(".migration > .splash-overlay").addClass("legacy"), e(".splash-cta").addClass("em-button yellow"));
            var o = "splashtooltip";
            e("body").on("mouseenter", ".splash-tooltip-trigger", function() {
                if (e("#" + o).length) e("#" + o).fadeIn();
                else {
                    var a = e(this),
                        i = a.data(),
                        s = i.content,
                ...
                e(window).width() > a.breakpoints.resizeBanners ? (e(".ud").removeClass("fadein").show(), e(".sd").hide(), e(".large-deal").addClass("show-deal").removeClass("hide-deal"), e(".small-deal").removeClass("show-deal").addClass("hide-deal")) : (e(".sd").removeClass("fadein").addClass("addTop").show(), e(".ud").hide(), e(".large-deal").removeClass("show-deal").addClass("hide-deal"), e(".small-deal").addClass("show-deal").removeClass("hide-deal"))
            }), e("body").on("click", ".splash-collapsable", function() {
                e(this).find("h3 i").removeClass("rotate").removeClass("down-arrow").removeClass("up-arrow"), e(this).find("section").hasClass("opened") ? (e(this).find("section").removeClass("opened"), e(this).find("h3 i").removeClass("rotate").removeClass("up-arrow").addClass("down-arrow")) : (e(this).find("h3 i").removeClass("down-arrow").addClass("up-arrow"), e(this).find("section").addClass("opened")), e("#pane-2").height() > window.innerHeight ? (e(".migration > .splash-wrapper").addClass("splash-supersticky"), a.video.width = a.video.shrinkWidth, a.video.height = a.video.shrinkHeight) : (e(".migration > .splash-wrapper").removeClass("splash-supersticky"), a.video.width = a.video.defaultWidth, a.video.height = a.video.defaultHeight)
            });
            var i = navigator.userAgent.match(/(Windows|Macintosh|CrOS)/i);
            i && e("#pane-3").trigger("click"), "True" == e("#hdnAutoShowSplash").val() && a.raiseIt("splash", 1, "splash", !1), "True" == e("#hdnAutoShowBrickWall").val() && a.raiseIt("splash", 1, "splash", !1)
        },
        watchIt: function() {
            function o(o, i) {
                o ? (a.notify(i + " condition is true", !0), e(".migration > .splash-wrapper").removeClass("splash-supersticky").addClass("shrinkWrap"), a.video.width = a.video.shrinkWidth, a.video.height = a.video.shrinkHeight) : (a.notify(i + " condition is false", !0), e(".migration > .splash-wrapper").removeClass("shrinkWrap"), a.video.width = a.video.defaultWidth, a.video.height = a.video.defaultHeight)
            }
            a.notify("watching body for resize"), e(window).on("scroll", function(i) {
                a.notify(i.isTrigger ? " triggerd" : " scroll", !0), o(e(window).scrollTop() < 300, "scroll"), i.isTrigger || (clearTimeout(this._timer), this._timer = setTimeout(function() {
        ...
        animateIt: function(o) {
            ...
            setTimeout(function() {
                s.animate({
                    ...
                    s.css("visibility", "visible").addClass("addTop"), i.fadeIn()
                })
            }, a.animation.delay)
        },
        checkIt: function(o) {
            if ("banners" === o) window.innerWidth < a.breakpoints.banners ? (a.logIt("left_rail", "impression"), a.animateIt(".small-deal")) : (a.logIt("banner", "impression"), a.seenIt("banners", a.cookieName.banners, "migrationBanners", !1), a.animateIt(".large-deal"));
            else if ("size" === o) {
                var i = e("body").hasClass("pane-1") ? 1 : 2;
                a.notify("body had pane - " + i), e("#pane-" + i).height() > window.innerHeight ? (a.notify("pane is taller than body"), a.video.width = a.video.shrinkWidth, a.video.height = a.video.shrinkHeight, e(".migration > .splash-wrapper").addClass("shrinkWrap")) : a.notify("body is taller than pane"), a.watchIt()
            } else {
        ...
        raiseIt: function(o, i, s, n) {
            var t = (e.cookie ? e.cookie(a.cookieName[o]) : readCookie(a.cookieName[o]), e("body").data("bucket"));
            "splash" === o ? (a.notify("splash raised"), a.moveIt(self, i), "tagAlong" === s && (a.seenIt("tagAlong", a.cookieName.tagAlong, "migrationTagAlong", !1), a.lowerIt("tagAlong")), a.seenIt("splash", a.cookieName.splashes, "migrationSplash", !1), a.viewedIt(), window.scrollTo(0, 0), e("#cancellation-page").length && a.logIt("cancellation", "click"), a.logIt("splash_step_1", "impression"), e(".migration > .splash-bg").fadeIn(400, function() {
                e(".migration > .splash-overlay").show();
                var o = e(".splash-content2").height() + 100;
                e(".splash-content-brickwall-faq-container").css("margin-top", o + "px"), a.checkIt("size"), n && window.setTimeout(function() {
                    a.playIt()
                }, 500)
            })) : e(a.elements.tagalong).length && (a.notify("tagAlong raised"), e(".tagalong-banner").find(".bucket").hide(), e(".tagalong-banner").find(".bucket" + t).show(), e(".tagalong-banner").removeClass("slide_right").addClass("slide_left"), a.logIt("toast", "impression"))
        },
        lowerIt: function(o) {
            "splash" === o ? (a.notify("splash lowered"), e(".splash-overlay").hide(), e(".splash-bg").fadeOut()) : (a.notify("tagAlong lowered"), a.seenIt("tagAlong", a.cookieName.tagAlong, "migrationTagAlong", !1), e(".tagalong-banner").removeClass("slide_left").addClass("slide_right"))
        },
        boot: function() {
            e(document).ready(function() {
                a.listen(), (e(".large-deal").length || e(".small-deal").length) && a.checkIt("banners"), a.checkIt("tagAlong")
            })
        }
    };
    a.boot()
...
! function(e, t) {
    function a(e, a, o, i, n) {
        c || (t.LivePass.toggleTraces(s.toggleTraces), t.LivePass.init(s.serviceUrl, s.customerId), c = !0), l && (t.LivePass.cleanupMonitoringSession(e.get(0)), l.cleanup(), l = null), r(e, a, o, i, n)
    }
    ...
    function r(e, a, r, n, c) {
        ...
        u.cdnName = r, u.streamUrl = c, u.isLive = !1, u.bitrate = n, u.playerName = s.playerName, u.deviceType = t.ConvivaContentInfo.DEVICE_TYPE_PC, u.viewerId = a.UserId, u.tags = {
            courseId: a.CourseId,
            movieId: a.VideoId,
            category: a.Subjects,
            ...
            software: a.Software
        }, l = t.LivePass.createSession(e.get(0), u), l.setContentLength(a.Duration)
    }
    ...
    function i(e, t, a, r) {
        var o = "[" + +e + "-" + +t + "] " + a + " - " + r;
        return o.length > 128 && (o = o.substr(0, 128)), o
    }
    if (t && t.LivePass) {
        ...
        e(".player[data-conviva]").on("playUrl", function(t, r, o, i, n, s, l) {
            ...
            e.get("/ajax/player/conviva?courseId=" + +i + "&videoId=" + +n, function(e) {
                a(c, e, s, l, r), c.trigger("video.metadata.loaded", e)
            })
...
! function(n) {
    function e() {
        clearTimeout(y), clearTimeout(b), clearTimeout(w)
    }
    ...
    function a(n) {
        ...
        e.style.border = "none", e.style.width = "1px", e.style.height = "1px", e.src = d, l.append(e);
        var t = !0,
            o = setInterval(function() {
                t = document.hasFocus(), t || (clearInterval(o), l.trigger("deeplinking.success"))
            }, 100);
    ...
    function i(n) {
        document.location = d, y = setTimeout(function() {
            c(n)
        }, 2500)
    }
    ...
    function r(n) {
        var e = n.split("?");
        return n = e.shift() + "?", e.push("anticache=" + (new Date).getTime()), n + e.join("&")
    }

    function s(n, e) {
        e = e !== !1, (A || I) && (e = !0), n = r(n), v = v.replace("{scheme}", n), d = n, b = setInterval(t, 200), I && navigator.userAgent.match(/Chrome/) ? o() : (T || k) && document.hasFocus ? a(e) : i(e)
    }
    var l = n("body"),
        d = "",
        m = "",
    ...
    start: function() {
        $(".dropdown").each(function(n, o) {
            ...
            e.on("click", function(n) {
                $(this).toggleClass("opened"), $(this).hasClass("opened") ? $(this).trigger("dropdown.open") : $(this).trigger("dropdown.close")
                ...
                var o = $(this);
                d.find("li").removeClass("selected"), o.addClass("selected"), e.find("span").text(o.text()), e.trigger("dropdown.change", [o, o.data("value")]);
                var t = e.find("input");
                t.length && t.val(o.data("value")), e.removeClass("opened"), e.trigger("dropdown.close");
...
! function(e) {
    e(".filters").each(function(t, i) {
        function r(t) {
            n.removeClass("active"), t.addClass("active"), f.show();
            var i = t.find(".filter-content");
            i.length > 0 && (f.html(i.get(0).outerHTML), f.find(".filter-content").removeClass("hide")), "undefined" != typeof hideFilters && !!hideFilters == !1 || n.each(function(t, i) {
        ...
        if (0 !== n.length && 0 !== f.length) {
            ...
            n.on("click", function() {
                ...
                i ? e.get(i).done(function(e) {
                    t.trigger("filter.beforechange", t), r(t), f.html(e.html), t.trigger("filter.change", t)
                }) : (t.trigger("filter.beforechange", t), r(t), t.trigger("filter.change", t))
            })
        }
    })
}(jQuery);
! function(t) {
    ...
    function a() {
        ...
        return t.each(r.flows, function(t) {
            u.hasClass(t) && (e = t, l = t)
        }), r.flows[e]
    }
    var o, i, r, l, f = (t(document), t("body")),
        u = t(".step-container"),
        c = t(".step-container .panel");
    f.on("flow.setup", function(e, s) {
        r = s, o = a(), i = n(), t(window).on("popstate", function(t) {
        ...
        (a > i || 0 === a) && history.pushState && history.pushState({
            step: a
        }, e(a), "/" + s(a)), u.removeClass(o).addClass(r);
        var l = e(a);
        document.title = "Lynda.com" + (l ? " " + l : ""), i = a;
        var c = u.find(".step").eq(a);
        t("html").hasClass("no-touch") && c.hasClass("focus-first") && c.find("input, select, textarea").first().focus(), f.trigger("flow.viewstep", [i])
    });
    var d = -1;
    f.on("flow.ignorestep", function(t, e) {
        ...
        var n = t(this);
        if (n.hasClass("disabled") || n.is("[disabled]")) return !1;
        if (d > -1 && i + 1 === d) return f.trigger("flow.stepignored", d), !1;
        var c = n.data();
        c.flow && (u.removeClass(l).addClass(c.flow), u.removeClass(s(i)), l = c.flow, o = r.flows[c.flow], i = r.flows[c.flow].indexOf(c.url)), e.preventDefault();
        var p = i + 1;
...
! function(a) {
    ...
    var r = a("body");
    a(".animated-form input:not([type=hidden])").val(""), r.on("focus", ".animated-form input", function(n) {
        ...
        var i = !0,
            ...
            u = o.find(":submit"),
            d = o.find(".form-group");
        a(".message-cont").hide(), d.each(function() {
...
! function(e) {
    ...
    function i(e, i, o) {
        s = i || "Default File Content", fileTitle = o || "Default File Name", c ? (c.registerOnAuthorizationCallback(n), c.authorize()) : (c = new t, c.registerOnAuthorizationCallback(n), c.authorize())
    }
    ...
    function n() {
        var e = {
            ...
            t = new o;
        t.registerOnFileAddedCallback(uploadSuccess), t.addFile(e, s, null, !0)
    }

    function o() {
        this.boundary = "-------314159265358979323846", this.delimiter = "\r\n--" + this.boundary + "\r\n", this.closeDelimiter = "\r\n--" + this.boundary + "--"
    }
    var r, l = e("body"),
        a = e("[data-google-drive-client-id]").data("googleDriveClientId"),
        u = e("[data-google-drive-api-key]").data("googleDriveApiKey"),
        d = e("[data-google-drive-scope]").data("googleDriveScope"),
        c = null,
        s = fileTitle = "";
    ...
    i(".infinite").each(function(n, a) {
        function t() {
            if (!g && !s) {
                ...
                }), p && (a += "&" + p.name + "=" + p.value), g = !0, e.append("<li class='infinite-loading'><i class='svg loading-grey'></i></li>"), i.get(a).done(function(n) {
                    n.html ? (e.append(n.html), c++, i("body").trigger("infinite.scroll.after", e, c)) : (s = !0, i("body").trigger("infinite.scroll.complete", e))
                }).always(function() {
                    e.find(".infinite-loading").remove(), g = !1
                })
            }
        }
        var e = i(a),
            ...
            s = !1,
            p = null;
        o.appear(), o.on("appear", function(n, a) {
            var l = e.find(".card").length;
            !f && l < d || (i("body").trigger("infinite.scroll.before", e), r && r.length > 0 ? t() : i("body").trigger("infinite.scroll", e))
...
! function(o) {
    var e = o("body"),
        ...
        d = o("#jp-popUp"),
        l = (o("#jp"), "None");
    "undefined" != typeof lynda && "undefined" != typeof lynda.showJPBanner && (l = lynda.showJPBanner), e.on("click", ".dont-show-again", function() {
        window.localStorage.disableJPPopUp = !0
    }), e.on("click", ".close-x, .dont-show-again", function() {
        window.localStorage.disableJP = !0, d.remove(), a.remove()
    }), "JpBanner" == l && (a.insertAfter(n), a.addClass("show responsive-alert")), "JpPopUp" == l && d.addClass("show"), window.localStorage && (window.localStorage.disableJPPopUp && d.remove(), window.localStorage.disableJP && (d.remove(), a.remove()))
}(jQuery);
! function(a) {
    function t() {
        function t(a, t) {
        ...
        a("html").addClass("loaded"), a("[data-lazy-src], [data-lazy-srcset]").each(function() {
            var r = a(this),
            ...
            l && r.one("error", function() {
                ...
                a && a.length ? r.attr(e, a) : l && l.length && t(r, l), r.removeAttr("data-lazy-" + e)
            })
            ...
            if (r && 0 !== r.length) {
                ...
                if (e && e.length)
                    for (var l = e.split("-"), n = 0; n < l.length; n++) t.addClass(l[n]);
                t.appear(function() {
                    t.off("appear"), t.data("lazy-bg") ? t.css("background", t.data("lazy-bg") + ", url(" + r + ")") : t.css("background-image", "url(" + r + ")"), e && e.length && t.removeAttr("style"), t.removeAttr("data-lazy-bg-img data-lazy-bg")
                })
            }
        })
    }
    a("body").on("lazy.init", t), a("body").trigger("lazy.init")
}(jQuery);
! function(e) {
    ...
    e("body").on("listPlayer.add", function(r, i, a) {
        ...
        n.find(".lp-toc-container").find(".lp-item").each(function(t, r) {
            ...
            d.push(i)
        }), n.data("lpItems", JSON.stringify(d)), n.on("listPlayer.getItemFromToc", function(t, r) {
            ...
            e(this).find("#player-previous, #player-next").attr("disabled", "disabled"), r.id !== n.data("currentItemId") && e(this).find("#player-previous").removeAttr("disabled"), i.id !== n.data("currentItemId") && e(this).find("#player-next").removeAttr("disabled")
        }).on("listPlayer.isLastItem", function(t, r) {
            if (r) return r === n.data("currentItemId");
            ...
            if (e.each(r, function(e, r) {
                ...
                var a = ++t[0].index;
                return a === r.length && (a = r.length - 1), r[a]
            }
            ...
            if (r) return void e(this).trigger("listPlayer.item.error", [i]);
            ...
            n.data("currentItemId", r.id), e.post("/ajax/listPlayer/playItem", r).done(function(e) {
                var t = e;
                n.data("cdns", JSON.stringify(t)), n.trigger("listPlayer.playItemUrl", [0 === t.length ? "No stream information available" : null, r, i])
            }).fail(function(e) {
            ...
            clearInterval(l), n.trigger("listPlayer.playItem", a)
            ...
            i.find(".lp-item").removeClass("current").removeClass("upnext"), a.addClass("current"), i.trigger("autoscroll.enable"), i.trigger("autoscroll.update", a)
            ...
            if (r) return n.trigger("listPlayer.onload", a), void n.find(".lp-player-container").find("video.player").find("track").data("initial", null)
            ...
            n.find(".lp-player-container").find(".mejs-time-float").hide(), n.trigger("listPlayer.updateNavButtonsState"), r.trigger("listPlayer.updatetoc", a), 0 === t.target.currentTime && n.find(".lp-player-container").find("video.player").data("logViews") && e.get("/ajax/listPlayer/viewedItem?itemId=" + +a.id + "&itemType=" + a.type, function(e) {
            ...
            console.log("ended"), n.trigger("listPlayer.video.ended")
            ...
            n.data("currentItemId", d.id), a += "/" + d.course + "/" + d.id, e("body").trigger("before.video.start", a)
            ...
            if (r) {
                ...
                d.removeAttr("data-last-viewed"), a.attr("data-last-viewed", !0).removeClass("current"), o.addClass("upnext"), i.trigger("autoscroll.enable"), i.trigger("autoscroll.update", o)
            }
            var c = n.find(".lp-player-container").find('link[rel="postroll"]').attr("href");
            e.ajax({
                url: c,
                success: function(e, t) {
                    if (n.find(".lp-player-container").find(".mejs-postroll-layer-content").html(e.html), n.find(".lp-player-container").find("video.player").data("continuousPlay")) {
                        ...
                        r.data("countdown-time", n.find(".lp-player-container").data("nextVideoCountdown")), i.text(n.find(".lp-player-container").data("nextVideoCountdown"));
                        l = setInterval(function() {
                            var e = parseInt(r.data("countdown-time"));
                            e = --e, i.text(e), r.data("countdown-time", e), e <= 0 && (clearInterval(l), a.find(".lp-item.upnext").find(".item-name").trigger("click"))
                        }, 1e3)
                    }
                }
...
! function(a) {
    a(function() {
        a("html").hasClass("legacy") && (a(".reactivation > .splash-bg").addClass("legacy"), a(".reactivation > .splash-overlay").addClass("legacy"))
    });
    var i;
    (a("body").hasClass("am-overlay") || "True" === a("body").data("am")) && (a("body").on("click", ".am-link", function(o) {
        ...
        var e = a(this);
        o.preventDefault(), a(".video-modal").is(":visible") && a(".video-modal").hide(), window.scrollTo(0, 0), a(".aquisition > .migration-overlay-bg").fadeIn(), a(".aquisition > .migration-overlay").fadeIn(), i = setTimeout(function() {
        ...
        var o = a(this);
        i.preventDefault(), a(".video-modal").is(":visible") && a(".video-modal").hide(), window.scrollTo(0, 0), a(".reactivation > .splash-bg").length ? (a(".reactivation > .splash-bg").addClass("loaded"), a(".reactivation > .splash-bg").fadeIn(400, function() {
            a(".reactivation > .splash-overlay").show(), a("#pane-reactivation").addClass("splashOpen").fadeIn()
        })) : window.location = o.attr("href")
    }), a("body").on("click", ".reactivation .btn", function(o) {
        var e = a(this);
        o.preventDefault(), a(".reactivation > .splash-overlay").hide(), a(".reactivation > .splash-bg").fadeOut(), a(".aquisition > .migration-overlay-bg").fadeIn(), a(".aquisition > .migration-overlay").fadeIn(), i = setTimeout(function() {
            window.location = e.attr("href")
        }, 3e3)
    }), "True" == a(".re-link").data("auto-redirect") && a(".re-link").click(), a("body").on("click", ".am-close", function(o) {
        clearTimeout(i), a("body").trigger("ga.event", {
            category: "acquisition migration",
            label: "acquisition migration: overlay closed",
            action: "impression"
        }), a(".migration-overlay-bg").fadeOut(), a(".migration-overlay").fadeOut()
    }))
}(jQuery);
! function(e, t) {
    var n, a, r, o, i, s = {
    ...
    e(".player").each(function(l, u) {
        function p(s, c) {
            r && r[0] && r[0] === s || (r = e(s), a = r.parent(), o = a.find(".mejs-time-indicator"), i = a.find(".mejs-time-float-custom"), n = a.parents(".mejs-inner").find(".player"));
            var d = a.offset(),
                l = c.pageX - d.left,
                u = l - 23,
                p = r.width(),
                f = n.get(0).player.media.duration * (u / (p - 23));
            isNaN(f) || i.text(t.Utility.secondsToTimeCode(f, n.get(0).player.options)), u > p - 26 || u < -21 || (u > p - 46 ? i.css({
                right: (u - p + 23).toString() + "px"
            }) : u < 0 ? i.css({
                left: (-u).toString() + "px"
            }) : i.removeAttr("style"), o.css({
                left: u.toString() + "px"
            }))
        }
        ...
        function m(t) {
            var n = "";
            t.target && (n += "BASE URI: " + t.target.baseURI, n += " CURRENT SRC: " + t.target.currentSrc, n += " BROWSER UA: " + navigator.userAgent), y({
                code: 9900,
        ...
        var v = e(u).data();
        v.features && v.features.length && (s.features = v.features.split(","), delete v.features), v = e.extend(!0, {}, s, v), v.error = m;
        ...
        e(k.container).on("exitedfullscreen", function(e) {
            ...
            function i(e) {
                a >= 0 && (e.target.currentTime = a), e.target.removeEventListener("loadeddata", i)
            }
            k.isLoaded = !1;
            var s = n || e(k.media).data("src");
            if (s && s.length && (n = s, e(k.media).data("src", "")), k.setSrc(n), k.play(), a) try {
                k.setCurrentTime(a)
            } catch (d) {
            ...
            k.pause(), k.setCurrentTime(0)
        }).on("track.load", function(e, t) {
            if (k.tracks && k.tracks.length) {
                var n = k.tracks[0];
                n.src = t, n.isLoaded = !1, n.mode = "hidden", k.loadTrack(0)
            }
...
! function(t) {
    ...
    o.on("keyup", ".add-pl-name", function(e) {
        ...
        content: function() {
            return t(".popover").not(this).popover("destroy"), t(".copy-playlist-confirm").clone().removeClass("hide").html()
        }
    }).on("shown.bs.popover", function(o) {
        var l = t(o.target),
            a = l.closest("li").find(".playlist-title").text();
        t(".popover").find("#copy-pl-name").val(a), e = l.data("playlistId")
        ...
        content: function() {
            return t(".popover").not(this).popover("destroy"), t("#playlist-confirm-item-delete").clone().removeClass("hide").html()
        }
        ...
        t(".copy-playlist").popover("destroy"), e.preventDefault()
    }), o.on("click", ".playlist-confirm-cancel", function(e) {
        t(".delete-playlist-item").popover("destroy"), o.trigger("card.deactivate")
    }), o.on("click", ".playlist-delete-action", function(a) {
        null !== l && (t(".delete-pl-flyout").popover("hide"), l.addClass("removed-item"), setTimeout(function() {
            l.remove()
        }, 400), t.ajax({
            url: "/ajax/playlist",
            data: {
            ...
            0 === t.playlists.PlaylistDeleteErrors && (o.trigger("playlist.delete", [e]), l = null)
        }))
        ...
        a = null, t.post("/ajax/playlist/copy", {
            playlistId: e,
            ...
            if (0 === l || 8 === l) {
                var i = +e.PlaylistId;
                o.trigger("playlist.add", [i]), a = i, t(".copy-playlist-cont").addClass("slider")
            }
        })
...
! function(a) {
    function t(t) {
        var l = a(t);
        0 !== l.length && (x = !!l.data("itemLevel"), a("html").hasClass("remove-pl") || l.popover("destroy").popover({
            html: !0,
            animation: !1,
            placement: function(t, l) {
                x = !!a(l).data("itemLevel"), !x && a(l).data("videoId") && (currentVideoId = a(l).data("videoId")), y(a(l), a(t));
            ...
            content: function() {
                return a(".popover").not(this).popover("hide"), a(".pl-flyout").clone().removeClass("hide").html()
            }
        }).on("shown.bs.popover", function(t) {
            if (a(t.target).hasClass("playlist-control")) {
                f(), j && (j = !1);
                var l = a(t.target);
                I = a(".pl-flyout.popover-instance"), I && I.find(".add-new-playlist button").focus(), x = !!l.data("itemLevel") && !!l.data("itemLevel"), currentVideoId = currentVideoId, l.addClass("active-popover-button"), h.trigger("playlist.popover.available", l)
            }
        }).on("hide.bs.popover", function(t) {
            a(t.target).hasClass("playlist-control") && (contextItem = null, a(".active-popover-button").removeClass("active-popover-button"), a(".playlist-control-cont").removeClass("slider"))
        }), h.trigger("playlist.control.initComplete", l))
    }

    function l() {
        a(".playlist-control").popover("hide"), a(".playlist-control-cont").removeClass("slider")
    }
    ...
    function e(a, t, l) {
        if (I && x) {
            ...
            "delete" === l ? i.removeClass("btn-primary").addClass("btn-secondary") : "add" === l && i.removeClass("btn-secondary").addClass("btn-primary"), i.find("i").toggleClass("hide");
            var s = e.find(".playlist-item-types"),
                n = e.find(".playlist-item-status-icon");
            s.find(".btn-primary").length > 0 ? n.removeClass("plus-sign").addClass("checkmark") : n.addClass("plus-sign").removeClass("checkmark"), C ? s.hide() : s.addClass("fadeOut"), m()
        }
    }

    function i(t, l, e, i) {
        x || i.find(".playlist-item-status-icon").removeClass("checkmark").addClass("svg loading-white"), a.ajax({
            ...
            return a.pl.Success ? (i.removeClass("added"), x && i.removeClass("btn-primary").addClass("btn-secondary"), void h.trigger("playlist.item.delete", [+e, +t, l])) : void i.find(".playlist-item-status-icon").removeClass("svg loading-white").addClass("checkmark")
        })
    }

    function s(t, l, e, i) {
        x || i.find(".playlist-item-status-icon").removeClass("plus-sign").addClass("svg loading-white"), a.post("/ajax/playlist/item", {
            itemId: +t,
            playlistId: +e,
            itemType: l
        }).done(function(a) {
            var s = +a.pl.PlaylistItemSaveErrors;
            return 0 === s || 1 === s ? (i.addClass("added"), void h.trigger("playlist.item.add", [+e, +t, +l])) : void i.find(".playlist-item-status-icon").removeClass("svg loading-white").addClass("plus-sign")
        })
    }
    ...
    function n() {
        if (I) {
            var t = I.find(".add-pl-name"),
                ...
                i = +k.data("courseId") || 0,
                s = g;
            if (0 === i) + k.data("videoId") > 0 ? (s = b, i = +k.data("videoId"), d(l, e, i, s)) : o(l, e);
            else {
                if (x) {
                    var n = a(".create-playlist .playlist-item-types button.btn-primary");
                    s = +n.data("itemType") || g, i = s === b ? currentVideoId : i
                }
                d(l, e, i, s)
            }
        }
    ...
    function d(t, l, e, i) {
        a.post("/ajax/playlist/createplaylistwithitem", {
            ...
            var n = +s.pl.PlaylistItemSaveErrors,
                o = +s.pl.PlaylistId;
            if (0 === n && (k.addClass("added"), h.trigger("playlist.add", [+o, t, l, +e, i]), h.trigger("playlist.item.add", [+o, +e, i]), a(".playlist-control-cont").removeClass("slider"), x)) {
                E = null, f(), a(".add-pl-name, .add-pl-desc").val("");
                var d = a(".pl-flyout-item-level.popover-instance .create-playlist .playlist-item-types button");
                d.removeClass("btn-primary").addClass("btn-secondary"), d.last().addClass("btn-primary").removeClass("btn-secondary")
            }
        })
    }
    ...
    function p(t, l, e, i) {
        if (k) {
            if (i === g) {
                ...
                n && (s = n.toString().split(",")), s.length > 0 && (s = s.map(Number)), "add" === t && s.indexOf(l) === -1 ? s.push(l) : "delete" === t && s.splice(a.inArray(l, s), 1), k.data("playlistIds", s.join(","))
            }
            if (x || i === b) {
                if (I) {
    ...
    function c(t, l, e) {
        ...
        s && (i = s.toString().split(",")), i.length > 0 && (i = i.map(Number)), "add" === l ? i.push(e) : "delete" === l && i.splice(a.inArray(e, i), 1), t.data("playlistItemIds", i.join(",")), t.attr("data-playlist-item-ids", i.join(","))
    }

    function y(t, l) {
        if (t && l && (k = t, I = l), a("html").hasClass("remove-pl") && u(), k && I) {
            var e = k.data("playlistIds");
            e ? (e = e.toString().split(","), e.forEach(function(a) {
                var t = I.find("li[data-playlist-id=" + +a + "]");
                t.length > 0 && (t.addClass("added"), t.find(".playlist-item-status-icon").removeClass("plus-sign").addClass("checkmark"))
            ...
            if (x || i === b) {
                ...
                I.find("li").each(function(t, l) {
                    ...
                    if (n.length > 0 && (n = n.map(Number)), n.indexOf(currentVideoId) > -1 && (i === b && a(l).addClass("added"), a(l).find(".playlist-item-status-icon").removeClass("plus-sign").addClass("checkmark"), x)) {
                        var o = a(l).find(".playlist-item-types button[data-item-type=" + b + "]");
                        o.removeClass("btn-secondary").addClass("btn-primary"), o.find("i").removeClass("hide")
                    }
                    if (n.indexOf(s) > -1) {
                        var d = a(l).find(".playlist-item-types button[data-item-type=" + g + "]");
                        d.removeClass("btn-secondary").addClass("btn-primary"), d.find("i").removeClass("hide")
                    }
                })
            }
            m()
    ...
    function m() {
        if (k && I) {
            ...
            0 === I.find(".playlist-item-status-icon.checkmark").length ? (a.hasClass("checkmark") && a.removeClass("checkmark").addClass("plus-sign"), a.siblings(".single-bookmark").removeClass("bookmarked").addClass("bookmark-outline")) : (a.addClass("checkmark").removeClass("plus-sign"), a.siblings(".single-bookmark").addClass("bookmarked").removeClass("bookmark-outline"))
        }
    }
    ...
    function f() {
        ...
        if (I) {
            ...
            if (t) {
                if (null !== E) return t.html(E), h.trigger("playlist.popover.refresh"), v();
                w = !0, j && t.addClass("loading"), a.get("/ajax/playlists").done(function(a) {
                    a && a.html && 0 !== a.html.length && (t.html(a.html), E = a.html, t.removeClass("loading"), h.trigger("playlist.popover.refresh"))
                }).always(function() {
                    w = !1, v()
                })
            }
    ...
    var h = a("body"),
        ...
        j = !0,
        x = !1;
    currentVideoId = 0, h.on("playlist.popover.available", function(t, l) {
        var e = a(l ? l : this);
        a(".add-playlist-btn"), e.data("screenVersion") || "total";
        k = e, r(), I && 0 === I.find(".add-new-playlist").length && I.find(".playlist-control-cont").css({
            height: "auto"
        })
        ...
        var l = a(this),
            ...
            n = +k.data("courseId") || 0,
            o = g;
        if (0 === n && +k.data("videoId") > 0 && (n = +k.data("videoId"), o = b), x) {
            var d = l.find(".playlist-item-types");
            return C ? d.show() : d.removeClass("fadeOut"), a(".playlists-flyout-menu .playlist-item-types").not(d).addClass("hide"), void d.toggleClass("hide")
        }
        ...
        E = null, h.trigger("ga.event", {
            ...
            label: "playlist-item",
            value: l
        }), p("add", t, l, i), e(t, i, "add"), r()
    }), h.on("playlist.item.delete", function(a, t, l, i) {
        E = null, h.trigger("ga.event", {
            action: "delete",
            label: "playlist-item",
            value: l
        }), p("delete", t, l, i), e(t, i, "delete"), r()
        ...
        if (C) l.show();
        else if (l.hasClass("fadeOut")) return l.removeClass("fadeOut"), !1;
        ...
        return r ? i(d, e, o, n) : s(d, e, o, n), a(this).blur(), !1
    }), h.on("click", ".create-playlist .playlist-item-types button", function(t) {
        a(".create-playlist .playlist-item-types button").removeClass("btn-primary").addClass("btn-secondary"), a(this).addClass("btn-primary").removeClass("btn-secondary")
    }), h.on("course.video.change", function(a, t, l) {
        currentVideoId = l, y(k, I)
    }), h.on("playlist.rename playlist.delete playlist.add playlist.item.add playlist.item.delete", f), h.on("click", ".playlist-control-close, .cancel-add-playlist", l), h.on("click", ".add-new-playlist", function() {
        a(".playlist-control-cont").addClass("slider"), a(".add-pl-name").focus(), a(".create-new-playlist .playlist-item-types")[x ? "removeClass" : "addClass"]("hide")
    }), h.on("click", ".playlist-control-title, .back-to-list", function() {
        a(".playlist-control-cont").removeClass("slider"), a(".add-pl-name").blur()
        ...
        var l = a(this);
        l && l[0] && l[0].click && 13 == t.keyCode && (t.preventDefault(), a(this)[0].click())
...
! function(l) {
    l("body").on("click", ".playlist-follow", function(o) {
        ...
        s.hasClass("following") ? l.post("/ajax/playlist/unfollow", {
            ...
            playlistId: a
        }), i.toggleClass("following"), i.children(".follow-icon").toggleClass("plus-sign checkmark")
    })
}(jQuery);
! function(o) {
    var e = o("body");
...
! function(a) {
    a("body").on("click", ".rating input", function() {
        ...
        if (void 0 != i && (void 0 == n || e != n)) {
            ...
            void 0 === r && (r = lynda.jsTrackingPageKey), a.post("/ajax/user/ratings", {
                urn: i,
                value: e,
                pageKey: r
            }).done(function(n) {
                "ok" === n.Status ? t.data("previousValue", e) : t.find("input:checked").attr("checked", !1), a("body").trigger("user.ratings.rated", {
                    urn: i,
                    value: e
                })
            })
...
! function(e) {
    function t(e, t, n) {
        ...
        r.type = "text", r.name = t, r.value = n, e.appendChild(r)
    }
    ...
    function u(e) {
        var t = e.toISOString();
        return t = t.replace(/-/g, ""), t = t.replace(/:/g, ""), t = t.replace(".000", "")
    }
    ...
    function i(e) {
        var t = [],
            n = [],
            r = [];
        return e.sunday && (t.push(0), n.push("SU"), r.push("SUNDAY")), e.monday && (t.push(1), n.push("MO"), r.push("MONDAY")), e.tuesday && (t.push(2), n.push("TU"), r.push("TUESDAY")), e.wednesday && (t.push(3), n.push("WE"), r.push("WEDNESDAY")), e.thursday && (t.push(4), n.push("TH"), r.push("THURSDAY")), e.friday && (t.push(5), n.push("FR"), r.push("FRIDAY")), e.saturday && (t.push(6), n.push("SA"), r.push("SATURDAY")), {
            dayNumbers: t,
            dayLetters: n,
            dayWords: r
        }
    ...
    function c(e) {
        var t = "";
        return e.length > 0 && (t = "RRULE:FREQ=WEEKLY;WKST=SU;BYDAY=" + e.join()), t
    }

    function p(e) {
        var t = "";
        return e.length > 0 && (t = "1wk" + e.join("")), t
    }
    ...
    g.on("reminders.calendar.create", function(s, m) {
        if ("undefined" != typeof m) {
            ...
            var D = i(m),
                ...
                v = D.dayNumbers.join();
            if (v.length > 0)
                for (; v.indexOf(g.getDay()) === -1;) g.setDate(g.getDate() + 1);
            ...
            var w = "";
            if ("google" === m.client) w = r(m.summary, m.details, m.url, c(T), o(g), o(S)), window.open(w);
            else if ("yahoo" === m.client) w = a(m.summary, m.details, m.url, p(D.dayLetters), u(g), h(m.duration)), window.open(w);
            else {
                var Y = c(D.dayLetters),
                    A = o(g),
                    C = o(S),
                    R = document.createElement("form");
                R.method = "POST", R.action = "/reminders/calendar/ics/download";
                var L = document.createElement("input");
                L.type = "hidden", L.name = "-_-", L.value = lynda["-_-"], R.appendChild(L), t(R, "uid", M), t(R, "timestamp", U), t(R, "startTime", A), t(R, "endTime", C), t(R, "summary", m.summary), t(R, "details", m.details), t(R, "url", m.url), t(R, "repetition", Y), document.body.appendChild(R), R.submit()
            }
...
! function() {
    ...
    if (e && e.timing && lynda.requestId && lynda.renderTime) {
        ...
        i.timing.renderTime = lynda.renderTime, $.post("/ajax/timing/request", i)
    }
}();
! function(t) {
    function n(n) {
        function i(t, n) {
            c.stop(!0), c.animate({
                ...
                r(), e.trigger("scrolly.scrollComplete", c)
        ...
        function r() {
            ...
            if (O = t.grep(w, function(t) {
                    if (t.right > o) return o = t.left + i, !0
                }), r = w[w.length - 1].right, O.length > 1) {
                var a = O.pop();
                O.push({
                    scrollLeft: r - i - e,
                    right: r,
        ...
        function a() {
            o(m, b > 0), o(v, b < O.length - 1)
        }

        function s() {
            var n = c.scrollLeft(),
                e = t.grep(O, function(t) {
                    if (t.scrollLeft >= n) return !0
                })[0];
            e && (b = I = O.indexOf(e))
        }
        ...
        function f() {
            ...
            var n = g && g.length ? c.find("li:not(.prepended) ." + g) : c.children(),
                ...
                i = n.index(e);
            if (i && (M = Math.abs(i - x) || 1, x = i), b >= O.length - 1 - h && !y && !C && d) {
                y = !0;
                var l = d + (d.indexOf("?") > -1 ? "&" : "?") + "start=" + n.length + "&limit=" + M * u;
                L && (l += "&" + L.identifier + "=" + L.selectedValue), t.get(l).done(function(t) {
                    t.html || (C = !0), c.append(t.html), r(), f()
                }).always(function() {
                    y = !1
                })
            }
        ...
        var c = t(n),
            ...
            x = 0,
            M = 0;
        r(), c.on("scrolly.filter.before", function(t, n) {
            L = n
        }).on("scrolly.filtered scrolly.items.update", function(t) {
            c.scrollLeft(0), b = 0, I = 0, a()
        }), c.on("scroll", _.debounce(f, e.hasClass("no-touch") ? 0 : 250)), t(window).on("resize", _.debounce(function() {
            r(), i(O[b].scrollLeft, 0)
        }, 250)), p.find(".flipper").click(function(n) {
            r();
            var e = t(n.currentTarget).hasClass("slider-left") ? I - 1 : I + 1;
            e = Math.min(Math.max(parseInt(e), 0), O.length - 1), e !== I && (I = e, i(O[I].scrollLeft))
        }), r(), c.length && a(), e.trigger("scrolly.initComplete", c)
    }
    var e = t("body");
    ...
    e(".carousel-filter").each(function(r, l) {
        ...
        return t && 0 !== t.length ? void o.on("dropdown.change", function(r, l, n) {
            ...
            t.trigger("scrolly.filter.before", {
                ...
                console.log("scrolly", t), t.html(r), t.trigger("scrolly.filtered")
            })
...
! function(t) {
    ...
    t(".show-more").each(function(a, n) {
                    ...
                    if (s && 0 !== s.length) {
                        ...
                        e.on("more.url", function(t, e) {
                            ...
                            if (!d && !h) {
                                ...
                                }), c.length > 0 && (o += c), d = !0, s.removeClass("hide"), t.get(o).done(function(t) {
                                    t.html && 0 !== _.trim(t.html).length ? (n.append(t.html), e.trigger("more.load", n)) : (h = !0, e.trigger("more.done", n), r.addClass("hide"))
                                }).always(function() {
                                    s.addClass("hide"), d = !1
                                })
                            }
        ...
        e.preventDefault(), t(this).hide().prev().removeClass("truncate")
    }), e.on("click", ".truncate +p .show-more", function(e) {
        e.preventDefault(), t(this).hide().parent().prev().removeClass("truncate")
        ...
        if (r.length) {
            ...
            o.toggleClass("opened"), l.siblings(":gt(" + (s - 1) + ")").toggle(), r.toggleClass("more"), r.hasClass("more") ? (h.html(_.template(i)({
                showText: n,
                title: d
            })), c.html(n), r.attr("aria-expanded", !0), o.find(".first-hidden").focus()) : (h.html(_.template(i)({
                showText: a,
                title: d
            })), c.html(a), r.attr("aria-expanded", !1))
        }
    })
}(jQuery);
! function(t) {
    function e() {
        ...
        t(".video-locked-msg").addClass("hide"), r || (t(".video-locked-msg").removeClass("hide"), a = t("#course-page").data("initial-video-id"), t(".embed-tab").data("ga-label", "embed-tab-locked"), i.find("button").data("ga-label", "embed-share-url-copy-locked"));
        var u = o(a, n, s, l, d, c);
    ...
    if (0 !== t(".social-share-control").length) {
        var a = t("body"),
            ...
            s = (a.popover({
                ...
                content: function() {
                    return t(".popover").not(this).popover("hide"), t(".ss-flyout").clone().removeClass("hide").html()
                }
            }).on("shown.bs.popover", function(o) {
                if (t(o.target).hasClass("social-share-control")) {
                    ...
                    if (i) {
                        ...
                        i != l ? (t("#org-share-video").removeClass("hide"), t("#org-share-video input").val(l).select()) : t("#org-share-url input").select()
                    }
                    n && t(".org-share").addClass("hide-copy-button"), a.addClass("active-popover-button"), n && t(".share-controls").addClass("no-button"), e()
                }
            }), {
        ...
        a.on("click", ".share-item", function(e) {
            ...
            if (t(this).hasClass("share-cert")) var r = t(".cert-options").data("ga-url") + "&utm_medium=certificateshare&utm_source=" + a,
                i = t(".cert-options").data("ga-title") + lynda.OpenGraphCertTitle;
            else var r = t('meta[property="og:url"]').attr("content"),
        ...
        var l, d = [];
        if (t("#org-share-url").length > 0 && void 0 !== typeof Clipboard && (l = new Clipboard("#org-share-url button"), d.push(l)), t("#org-share-video").length > 0 && void 0 !== typeof Clipboard && (l = new Clipboard("#org-share-video button"), d.push(l)), t("#public-share-url").length > 0 && void 0 !== typeof Clipboard && (l = new Clipboard("#public-share-url button"), d.push(l)), t("#embed-share-url").length > 0 && void 0 !== typeof Clipboard && (l = new Clipboard("#embed-share-url button"), d.push(l)), d.length > 0)
            for (var c = 0, u = d.length; c < u; c++) d[c].on("success", function(e) {
                var o = t("#clipboardConfirmation");
                o.addClass("show").text(e.trigger.getAttribute("data-confirm")), setTimeout(function() {
                    o.addClass("fadeOut"), a.one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function(t) {
...
! function(t) {
    t("[data-sticky-container]").each(function(n, i) {
        function o() {
            ...
            for (var i = 0; i < c.length; i++)
                for (var o = t(c[i]), d = o.find(e), f = n, r = 0, u = 0; u < d.length; u++) {
                    ...
                    if (l < f) {
                        var g = h - (r += y) - n;
                        k.css("paddingTop", y), p.addClass("sticky").css("z-index", "").css({
                            top: -n + f + (g < 0 ? g : 0),
                            width: k.outerWidth(),
        ...
        a.on("sticky.on", function() {
            a.on("scroll sticky.update", o), o()
        }), a.on("sticky.off", function() {
            a.off("scroll sticky.update", o), s()
        })
    })
}(jQuery);
! function(t) {
        ...
        if (e.data("tabs.init") !== !0) {
            ...
            t(this).on("shown.bs.tab", function(a) {
                ...
                t.get(n).done(function(a) {
                    ...
                    var n = e.attr("href"),
                        i = t(n);
                    0 !== i.length && (i.html(a.html), e.trigger("tab.change", e))
                })
            }), e.data("tabs.init", !0))
        }
    }
    ...
    function e(a) {
        ...
        if (e.data("collapsed-tabs") !== !0) {
            ...
            e.on("click", ".collapsed-tabs-display", function(a) {
                ...
                e.toggleClass("opened"), e.hasClass("opened") ? e.trigger("collapsedTab.open") : e.trigger("collapsedTab.close")
                ...
                if (window.innerWidth < 768) {
                    var i = t(this);
                    n.find("li").removeClass("active"), e.trigger("collapsedTab.change", [i.text()]), e.removeClass("opened"), e.trigger("collapsedTab.close")
                }
            }), e.data("collapsed-tabs", !0)
        }
    }
    t.fn.tabpanel = function() {
        $container = t(this), $container.find("ul").attr("role", "tablist"), $container.find('[role="tablist"] li').attr("role", "presentation"), t('[role="tablist"] li > a:not([role])').attr({
            role: "tab"
            ...
            var e, n = (t(this), t(this).parents("li").prev().children('[role="tab"]')),
                i = t(this).parents("li").next().children('[role="tab"]');
            switch (a.keyCode) {
                case 37:
                    e = n;
                    break;
            ...
            e.length && e.attr({
                tabindex: "0",
                "aria-selected": !0
            }).focus(), $container.find('[role="tabpanel"]').attr("aria-hidden", "true"), t("#" + t(document.activeElement).attr("href").substring(1)).attr("aria-hidden", null)
        }), $container.find('[role="tab"]').on("click", function(a) {
            a.preventDefault(), t(this).attr({
                "aria-selected": !0,
                tabindex: "0"
            }), $container.find('[role="tabpanel"]').attr("aria-hidden", "true"), t("#" + t(this).attr("href").substring(1)).attr("aria-hidden", null)
        })
    };
    var n = t("body");
    n.on("tabs.init", function(e, i, r) {
        i = t(i || n), i.find(".tabs").andSelf().filter(".tabs").each(function(t, e) {
            a(e)
        })
    }), n.on("collapsed-tabs.init", function(a, i, r) {
        i = t(i || n), i.find(".collapsed-tabs").andSelf().filter(".collapsed-tabs").each(function(t, a) {
            e(a)
        })
    }), n.trigger("tabs.init"), n.trigger("collapsed-tabs.init")
}(jQuery);
! function(n) {
                ...
                if (r) {
                    ...
                    if (1 !== f.length) {
                        var a = function() {
                            ...
                            u.length > 0 && (t = _.shuffle(t), n.each(_.shuffle(u).slice(0, 2), function(e, r) {
                                n(t[e]).attr("src", r)
                            }))
                        };
                        u = setInterval(a, 1500), a()
                    }
                }
            }
...
! function(e) {
    e(".tiles-container").find(".tiles").find(".see-all-tiles").on("click", function() {
        ...
        i.toggleClass("opened"), e(this).find(".tiles-toggle-icon").toggleClass("arrow-right").toggleClass("arrow-down")
    })
}(jQuery);
...
if (lynda.timing && supportsNavigationTiming()) {
    var timing = window.performance.timing,
        timingModel = {
            ...
            calc: function(e, t) {
                ...
                for (var a = 13 - i.length, r = 0; r < a; r++) n += " ";
                return i + n
            }
        },
        timingMetrics = {
    ...
    if (lynda.timingDisplay || "block" === lynda.timingDisplay) {
        ...
        headerTag.style.color = "white", headerTag.appendChild(header), box.appendChild(headerTag), box.style.border = "1px solid #333", box.style.backgroundColor = "#1e1e1e", box.style.color = "#999", box.style.width = "250px", box.style.height = "auto", box.style.borderRadius = "10px", box.style.position = "fixed", box.style.padding = "20px", box.style.top = "30px", box.style.left = "30px", box.style.zIndex = "1000000", box.style.opacity = "0.85";
        var pageHeaderTag = document.createElement("h3"),
            pageHeader = document.createTextNode("Page Data");
        pageHeaderTag.style.color = "white", pageHeaderTag.appendChild(pageHeader), box.appendChild(pageHeaderTag);
        for (var index in timingData.page) {
            var kiddo = document.createElement("p");
            kiddo.innerHTML = "* " + timingData.page[index].name + " = <span>" + timingData.page[index].metric + "</span>", box.appendChild(kiddo)
        }
        var serverHeaderTag = document.createElement("h3"),
            serverHeader = document.createTextNode("Server Data");
        serverHeaderTag.style.color = "white", serverHeaderTag.appendChild(serverHeader), box.appendChild(serverHeaderTag);
        for (var index in timingData.server) {
            var kiddo2 = document.createElement("p");
            kiddo2.innerHTML = "* " + timingData.server[index].name + " = <span>" + timingData.server[index].metric + "</span>", box.appendChild(kiddo2)
        }
        var clientHeaderTag = document.createElement("h3"),
            clientHeader = document.createTextNode("Client Data");
        clientHeaderTag.style.color = "white", clientHeaderTag.appendChild(clientHeader), box.appendChild(clientHeaderTag);
        for (var index in timingData.client) {
            var kiddo3 = document.createElement("p");
            kiddo3.innerHTML = "* " + timingData.client[index].name + " = <span>" + timingData.client[index].metric + "</span>", box.appendChild(kiddo3)
        }
        var spans = box.getElementsByTagName("span"),
            i;
        for (i = 0; i < spans.length; i++) spans[i].style.color = "#bada55";
        var optionsTag = document.createElement("h3"),
            options = document.createTextNode("Querystring Options");
        optionsTag.style.color = "white", optionsTag.appendChild(options), box.appendChild(optionsTag);
        ...
        optionsTagListItem1.style.color = "white", optionsTagListItem1.appendChild(options), optionsTagList.appendChild(optionsTagListItem1);
        ...
        optionsTagListItem2.style.color = "white", optionsTagListItem2.appendChild(options), optionsTagList.appendChild(optionsTagListItem2);
        ...
        optionsTagListItem3.style.color = "white", optionsTagListItem3.appendChild(options), optionsTagList.appendChild(optionsTagListItem3);
        var footerTag = document.createElement("p"),
            footer = document.createTextNode("Check the console for extra data and messages");
        footerTag.style.color = "white", footerTag.appendChild(footer), box.appendChild(footer), document.body.appendChild(box)
    }
    if (console.log("***********Timing Overview****************"), console.log(" _____________  _____________  _____________  _____________  _____________  _____________  _____________  _____________  _____________"), console.log("|             ||             ||             ||             ||             ||             ||             ||             ||             |"), console.log("|redirect     ||unload       ||app cache    ||dns          ||tcp          ||request      ||response     ||processing   ||onload       |"), console.log("|" + timingMetrics.redirectTime + "||" + timingMetrics.unload + "||" + timingMetrics.appCacheTime + "||" + timingMetrics.dns + "||" + timingMetrics.connectionTime + "||" + timingMetrics.requestTime + "||" + timingMetrics.responseTime + "||" + timingMetrics.processing + "||" + timingMetrics.loadEvent + "|"), console.log("|_____________||_____________||_____________||_____________||_____________||_____________||_____________||_____________||_____________|"), console.log("***********Start Timing****************"), console.log("* Performance timing dump"), console.log(timing), console.log("******************** Server related *******************"), lynda.timingTable) console.table(timingData.server);
    else
        for (var index in timingData.server) timingModel.log(timingData.server[index].type, timingData.server[index].name, timingData.server[index].metric, timingData.server[index].message);
    if (console.log("******************** Client related *******************"), lynda.timingTable) console.table(timingData.client);
    else
        for (var index in timingData.client) timingModel.log(timingData.client[index].type, timingData.client[index].name, timingData.client[index].metric, timingData.client[index].message);
    if (console.log("******************** Page related *******************"), lynda.timingTable) console.table(timingData.page);
    else
        for (var index in timingData.page) timingModel.log(timingData.page[index].type, timingData.page[index].name, timingData.page[index].metric, timingData.page[index].message);
    if (console.log("***********End Timing****************"), window.performance.getEntries().length > 0) {
        console.log("***********Start Resources****************"), console.log("* Types of objects on your page");
        ...
        if (console.log("---Scripts (" + scripts.length + ")---"), lynda.timingVerbose && console.log(scripts), console.log("---CSS Files (" + styles.length + ")---"), lynda.timingVerbose && console.log(styles), console.log("---Ajax Requests (" + ajax.length + ")---"), lynda.timingVerbose && console.log(ajax), console.log("---Images (" + images.length + ")---"), lynda.timingVerbose && console.log(images), console.log("---Other (" + other.length + ")---"), lynda.timingVerbose && console.log(other), lynda.timingVerbose)
            for (var i = 0; i < window.performance.getEntries().length; i++) {
                var type = window.performance.getEntries()[i].initiatorType,
                    name = "";
                name = "xmlhttprequest" === type ? "* Ajax request - " : "img" === type ? "* Image request - " : "script" === type ? "* Script request - " : "css" === type || "link" === type ? "* CSS request - " : "* Other - ", console.log(name + window.performance.getEntries()[i].initiatorType + " (" + window.performance.getEntries()[i].name + ")")
            }
    ...
    var o = {
        ...
        listen: function() {
            t("body").on("click", ".toast-close", function() {
                ...
                o.notify("Toast Shown"), o.raiseToast(n)
            })
        },
        getHTML: function(n) {
            o.notify(n);
            ...
            if (s) {
                ...
                e.append(s), a.removeClass("toast-closed")
            }
        },
        raiseToast: function(t) {
            o.notify("toast raised"), o.getHTML(t), setTimeout(function() {
                o.notify("Its been " + t.delay + " and I am closing toast"), o.lowerToast()
            }, t.delay || 7e3)
        },
        lowerToast: function() {
            o.notify("toast lowered");
            var n = t(".toast");
            o.notify(n), n.hasClass("animate-in") ? (n.removeClass("animate-in regular").addClass("animate-out"), setTimeout(function() {
                n.remove()
            }, 500)) : n.remove()
        },
        template: function(t) {
...
! function(a) {
    function t(a, t) {
        void 0 !== t && null !== t && (t.site_version = utag_data.site_version, utag_data.site_section && (t.site_section = utag_data.site_section), !t.page_name && utag_data.page_name && (t.page_name = utag_data.page_name), utag_data.page_type && (t.page_type = utag_data.page_type), utag.view(t))
    }

    function e(a, t) {
        void 0 !== t && null !== t && (utag_data.site_version && (t.site_version = utag_data.site_version), utag_data.site_section && (t.site_section = utag_data.site_section), utag_data.page_name && (t.page_name = utag_data.page_name), utag_data.page_type && (t.page_type = utag_data.page_type), utag.link(t))
    }
    var n = a("body");
    n.on("udo.link", e), n.on("udo.view", t), a("[data-utag-event-type]").click(function(t) {
        var n = {};
...
! function(e) {
    ...
    function a(e) {
        ...
        t[e ? "removeClass" : "addClass"]("hide"), setTimeout(function() {
            e ? t.removeClass("fade-out").addClass("fade-in") : t.removeClass("fade-in").addClass("fade-out")
        }, 1)
    }

    function i() {
        a(!1), l && o.find("video").get(0).pause(), o.find(".pod-watching-cont").removeClass("hide"), o.find(".course-description").html(""), o.find(".modal-title, .author-name, .level-text, .pod-duration, .pod-viewers, .date-updated, .date-released").text(""), o.find(".author-image").attr("src", ""), o.find(".level").attr("class", "level"), o.find(".continue-button").closest("button").unbind("click")
    }

    function d(e) {
        o.modal("hide"), i(), o.hasClass("path-modal") || r.trigger("ga.event", {
            action: "click",
            label: "preview-close"
        })
    }
    ...
    if (o && 0 !== o.length) {
        ...
        r.on("click", ".video-launch", function(t) {
            t.preventDefault(), modalData = e(this).data(), o.data(modalData), (modalData.videoSrc || modalData.videoId) && o.modal("show")
        });
        var l = !1;
        o.on("shown.bs.modal", function(r) {
            ...
            if (c && n.on("ended", window[c]), !s && !u) {
                var f = o.data("videoSrc");
                if (void 0 != f) {
                    var v = o.data("videoTitle");
                    return o.find(".modal-title").text(v), n.trigger("playUrl", [f])
                }
                return d()
            }
            i(), l = !0, t(!0), e.get("/ajax/video/preview?videoId=" + s + "&courseId=" + u, function(i) {
                var d = 540,
                    r = i.Video.PrioritizedStreams[0][d];
                n.trigger("playUrl", [r, null, u, s]), n.trigger("track.load", "/ajax/player/transcript?courseId=" + u + "&videoId=" + s), n.on("error", function(t) {
                ...
                }), o.find(".author-image").attr("src", i.Course.Authors[0].ThumbnailUrl), o.find(".course-description").html(i.Course.Description), o.find(".modal-title").text(i.Course.Title), o.find(".author-name").text(i.Course.Authors[0].Fullname), o.find(".level").addClass("level-" + i.Course.Level.toLowerCase()), o.find(".level-text").text(i.Course.Level), o.find(".pod-duration").text(i.Course.FormattedDuration), o.find(".pod-viewers").parent()[0 === +i.Course.Viewers ? "hide" : "show"](), o.find(".pod-viewers").text(i.Course.Viewers.toLocaleString()), o.find(".continue-button").unbind("click").click(function() {
                    window.location = i.Course.Url
                }), o.find(".free-trial").text(i.SignupCtaText.toLocaleString()).attr("href", i.SignupCtaLink), o.find(".date-updated").text(i.Course.DeltaDate), o.find(".date-released").text(i.Course.DateReleasedUtc), i.Course.ClosedCaptionsAvailable || o.find(".mejs-captions-button").hide(), a(!0), t(!1)
            })
        }), o.on("hidden.bs.modal", d), o.find(".nav-close").click(d)
    }
}(jQuery);
! function(t) {
    function i(t, i, a) {
    ...
    function a(a, n, o, d, l) {
        e && e.abort();
        var u = i(a, n, o);
        return lynda.culturePrefix && ~u.url.indexOf(lynda.culturePrefix) && (u.url = u.url.replace(lynda.culturePrefix, "")), e = t[u.method](lynda.culturePrefix + "/ajax" + u.url, o).done(function(i) {
            if (i) {
                var a = t("[data-wizardli-section]").each(function() {
                    var a = t(this),
                        e = a.data("wizardliSection"),
                        n = i[e];
                    if (d ? a.addClass("wizardli-back") : a.removeClass("wizardli-back"), i.viewId && a.attr("data-wizardli-view-id", i.viewId), n) {
                        oldContent = a.find(".wizardli-new-content"), oldContent.length || (oldContent = t("<span>"), oldContent.append(a.contents().detach())), oldContent.children().prop("disabled", !0), oldContent.removeClass("wizardli-new-content").one("webkitAnimationEnd oanimationend msAnimationEnd animationend", function(i) {
                            t(this).remove()
                ...
                if (t("[autofocus]").focus(), i.pageTitle) {
                    var e = lynda.culturePrefix + (i.url || u.url);
                    !l && history.pushState(u, i.pageTitle, e), document.title = i.pageTitle, r.trigger("wizardli.section.update", [a]), r.trigger("ga.pageview", [e])
                }
    ...
    if (t("[data-wizardli-section], [data-wizardli]").length && history && history.pushState && history.back) {
        ...
        t(window).on("popstate", function(t) {
            if (t.originalEvent) {
                if (!t.originalEvent.state && !n) return n = !0;
